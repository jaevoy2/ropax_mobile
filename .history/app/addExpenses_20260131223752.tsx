    ...
    const renderCameraCaptureView = () => {
        ...
        return (
            <View style={{ flex: 1, position: 'relative' }}>
                ...
                <TouchableOpacity style={{ position: 'absolute', top: 50, left: 20, zIndex: 5, backgroundColor: '#cf2a3a', padding: 8, borderRadius: 50 }} onPress={() => setOnCapture(false)}>
                    <Ionicons name={'arrow-back'} size={25} color="#FFFFFF" />
                </TouchableOpacity>
                
                <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', height: 180, width: '100%', position: 'absolute', bottom: 0, zIndex: 5, justifyContent: 'center' }}>
                    <TouchableOpacity style={{ alignSelf: 'center', backgroundColor: '#cf2a3a', padding: 12, borderRadius: 50 }}>
                                            ...
                                            <View style={{ marginTop: 5 }}>
                                                ...
                                                <TouchableOpacity onPress={() => handleOnCapture()} style={{ borderColor: '#b3b3b3', borderWidth: 1, borderRadius: 5, height: 60 }}>
                                                    {e.expense_image == null ? (
                                                        <View style={{ backgroundColor: '#f1f1f1', borderRadius: 5, height: '100%', justifyContent: 'center' }}>
