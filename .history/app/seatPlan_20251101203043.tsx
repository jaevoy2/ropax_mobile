            ...
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1} enableContentPanningGesture={false}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }}>
                        <TouchableOpacity onPress={addPasses} style={{ flexDirection: 'row', alignItems: 'flex-start', paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#cf2a3a', borderRadius: 5 }}>
                            <Ionicons name={'add'} color={'#fff'} size={20} />
                            <Text style={{ color: '#fff',fontSize: 14, fontWeight: 'bold'  }}>Add Passes</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 5 }} onPress={() => [setPassengers([]), passesSheetRef.current?.close()]}>
