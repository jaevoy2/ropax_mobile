    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ padding: 15 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomColor: '#CF2A3A', borderBottomWidth: 1, paddingBottom: 10 }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#CF2A3A' }}>{date}</Text>
                    <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                        <Text style={{ fontSize: 10 }}>Monthly Total Expenses:</Text>
