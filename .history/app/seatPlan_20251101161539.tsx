...
export default function SeatPlan() {
    ...
    const seatSnapPoints = useMemo(() => {
        if(passengers.length > 0 && passengers.length < 7) return ["26%"];
        
        if(passengers.length > 6) {
            const containerPercent = (containerHeight / height) * 100 + 15;
