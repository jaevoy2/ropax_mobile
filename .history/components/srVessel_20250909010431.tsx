    ...
    return (
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
            {items.map((seat) => (
                ...
                borderRadius: 3, backgroundColor: passengers.some((p) => p.seatNumber == Number(seat)) ? '#BA68C8' : touristSeat.includes(seat) ? '#E6E2C6' : 'transparent', alignItems: 'center', margin: 2 }}>
