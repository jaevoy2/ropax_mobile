...
export default function Forms() {
    ...
    const [clearOnChange, setClearOnChange] = React.useState(false);
                ...
                <ScrollView>
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 20 }}>
                            ...
                            <View style={{ flexDirection: 'row', gap: 3, alignItems: 'center', backgroundColor: '#000' }}>
                                <Checkbox.Item label='With Infant' status={clearOnChange ? 'checked' : 'unchecked'} />
                            </View>
                        </View>
                    ))}
                </ScrollView>
