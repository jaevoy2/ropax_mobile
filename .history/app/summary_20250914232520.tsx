    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ padding: 10 }}>
                <View style={{ backgroundColor: '#fff', borderColor: '#B3B3B3', borderWidth: 1, padding: 10, flexDirection: 'row', alignItems: 'flex-start' }}>
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                        ...
                        <Text style={{ fontSize: 16, fontWeight: '900', color: '#cf2a3a' }}>₱150.00</Text>
                    </View>
                </View>
            </View>
        </View>
