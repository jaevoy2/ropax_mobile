                    ...
                    {totalSheetLoading == true ? (
                        ...
                        <>
                            ...
                            <View style={{ flexDirection: 'row', gap: 5, alignItems: 'center', flexWrap: 'wrap', marginTop: 10 }}>
                                {trips?.map((trip) => (
                                    <TouchableOpacity onPress={() => {setTotalSheetLoading(true), setBottomSheetTripID(trip.trip_id), handleFetchTotalBookings(trip.trip_id)}} key={trip.trip_id} style={{ paddingHorizontal: 15, paddingVertical: 5, backgroundColor: bottomSheetTripID == trip.trip_id ? '#cf2a3a' : '#fff', borderRadius: 5, marginTop: 12, flexDirection: 'row', alignItems: 'center', borderColor: '#cf2a3a', borderWidth: 1 }}>
                                        <View>
