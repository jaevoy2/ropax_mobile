                            ...
                            <View style={{ marginTop: 25 }}>
                                ...
                                <View style={{flexDirection: 'row', justifyContent: 'space-between' }}>
                                    <View style={{ width: '70%' }}>
                                        ...
                                        <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                            <Dropdown onChange={(item) => {updateCargo(0, 'brand', item.value), setSelectdBrand(item.value)}} value={p.cargo?.brand} data={cargoProperties?.data.brands.map((b: any) => ({ label: b.name, value: b.id }))} labelField="label" valueField="value" placeholder="Select Brand" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                                containerStyle={{
                                    ...
                                    <View style={{ flexDirection: 'column', alignSelf: 'flex-end' }}>
                                        ...
                                        <View style={{ borderColor: '#FFC107', backgroundColor: '#ffc10727', borderWidth: 2, borderRadius: 5, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, width: 90 }}>
                                            <Text style={{ fontSize: 16 }}>₱</Text>
                                            <TextInput value={String(p.cargo?.cargoFare)} onChangeText={(text) => updateCargo(0, 'cargoFare', text)} editable={false} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', textAlign: 'right' }} />
                                        </View>
                                    </View>
                                </View>
                                <View style={{ width: '100%' }}>
                                    <Text style={{ fontSize: 9, fontWeight: 'bold', color: '#545454' }}>Brand:</Text>
                                    <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                        <Dropdown onChange={(item) => {updateCargo(0, 'brand', item.value), setSelectdBrand(item.value)}} value={p.cargo?.brandID} data={cargoProperties?.data.brands.map((b: any) => ({ label: b.name, value: b.id }))} labelField="label" valueField="value" placeholder="Select Brand" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                            containerStyle={{
                                                alignSelf: 'flex-start',
                                                width: '85%',
                                            }}
                                ...
                                <View style={{ marginTop: 5, flexDirection: 'row', justifyContent: 'space-between' }}>
                                    ...
                                    <View style={{ width: '48%' }}>
                                        ...
                                        <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                            <TextInput value={p.cargo?.plateNo} onChangeText={(text) => updateCargo(0, 'plateNo', text)} placeholder='Plate#' style={{ fontSize: 13 }} />
                                        </View>
                                    </View>
                                </View>
                            </View>
