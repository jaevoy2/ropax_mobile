        ...
        <View>
            <View style={{ flex: 1, marginTop: 10 }}>
                {passengers.map((p, index) => (
                    <View key={p.seatNumber ?? `pass-${p.passTypeCode}-${index}`} style={{ position: 'relative', borderColor: errorForm.includes(p.seatNumber ?? '') ? '#cf2a3a' : '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 20, backgroundColor: '#fff' }}>
