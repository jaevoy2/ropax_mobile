...
const SeatPlan: React.FC<SeatProps> = React.memo(({ start, limit, skipPattern = false, onSeatSelect, type, accomm_id, bookedSeats }) => {
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', width: 90, gap: 4, justifyContent: 'center' }}>
                    ...
                    {seatColumn1.map((seat) =>{
                        ...
                        return ( 
                            ...
                            backgroundColor: 
                                booked ? booked.station.color : isPassenger ? '#BA68C8' : seatColumn1.includes(seat) ? '#E6E2C6' : 'transparent'
                            }}> 
