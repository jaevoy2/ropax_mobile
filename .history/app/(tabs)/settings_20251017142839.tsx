            ...
            <View style={{ padding: 10 }}>
                <View style={{ paddingHorizontal: 15, paddingVertical: 25, backgroundColor: '#fff', borderRadius: 10, marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                        <Image source={defaultImg} style={{ borderRadius: 60, height: 60, width: 60 }} />
                        <View>
                            <Text style={{ fontWeight: '900', fontSize: 18, color: '#cf2a3a' }}>Dedal Boyet</Text>
                            <Text style={{ fontSize: 10, color: '#BEC4CE' }}>Ticketing Staff</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                        <Text style={{ fontSize: 10, color: '#BEC4CE' }}>Station</Text>
                        <Text style={{ fontSize: 13, color: '#cf2a3a', fontWeight: 'bold' }}>Hilongos Port</Text>
                    </View>
                </View>
