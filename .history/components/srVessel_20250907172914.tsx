...
const SeatPlan: React.FC<SeatProps> = ({ start, limit, skipPattern = false }) => {
    ...
    return (
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 2, alignItems: 'center' }}>
            {items.map((seat) => (
                <TouchableOpacity key={seat} style={{  paddingVertical: 2, width: 30, height: 30, borderColor: '#A9A9B2', borderWidth: 1, borderRadius: 3, backgroundColor: touristSeat.includes(seat) ? '#E6E2C6' : 'transparent', alignItems: 'center', justifyContent: 'center', margin: 2 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: 10, width: '80%', alignSelf: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', width: 90, gap: 4, justifyContent: 'center' }}>
                    ...
                    {seatColumn2.map((seat) => ( 
                        <TouchableOpacity key={seat} style={{ paddingVertical: 3, width: '32%', borderColor: '#A9A9B2', borderWidth: 1, borderRadius: 3, backgroundColor: '#E6E2C6' }}> 
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', width: 90, gap: 4, justifyContent: 'center' }}>
                    ...
                    {seatColumn3.map((seat) => ( 
                        <TouchableOpacity key={seat} style={{ paddingVertical: 3, width: '32%', borderColor: '#A9A9B2', borderWidth: 1, borderRadius: 3, backgroundColor: seat == 'C' || seat == 'D' ? '#E6E2C6' : 'transparent' }}> 
