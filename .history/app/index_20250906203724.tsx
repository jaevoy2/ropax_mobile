...
const type = ['Passenger', 'Rolling Cargo']
...
export default function Index() {
  ...
  return (
    <View style={{height: '100%', width: '100%', alignItems: 'center', backgroundColor: '#f1f1f1', }}>
      ...
      <View style={{ width: width, height: '42%', position: 'relative', }}>
        <View style={{ position: 'absolute', top: 40, zIndex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%', paddingHorizontal: 20 }}>
          <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
            <Image source={logo} style={{ borderRadius: 40, height: 40, width: 40, borderWidth: 2, borderColor: '#FFC107' }} />
            <View style={{ flexDirection: 'column' }}>
              <Text style={{ fontSize: 17, fontWeight: 'bold', color: '#FFC107', textShadowColor: '#696969', textShadowRadius: 4}}>LEOPARDS</Text>
              <Text style={{ fontSize: 8, color: '#fff', fontWeight: 'bold', textShadowColor: '#696969', textShadowRadius: 4 }}>MOTORBOAT SERVICES</Text>
            </View>
          </View>
          <TouchableOpacity style={{ paddingHorizontal: 20, paddingVertical: 8, backgroundColor: '#FFC107', alignItems: 'center', borderRadius: 30, justifyContent: 'center' }}>
