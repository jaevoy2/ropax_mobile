...
export default function Login() {
    ...
    return (
        <View style={{ height, position: 'relative', backgroundColor: '#fff' }}>
            ...
            <View>
                ...
                <Image source={yellowWave} style={{ height: 100, width: width + 50, position: 'absolute', bottom: -40, right: -20, zIndex: 1 }} /> 
            </View>
        </View>
    )
}
