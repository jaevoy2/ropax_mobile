                                ...
                                <View style={{ width: '56%', }}>
                                    ...
                                    <View style={{ flexDirection:'row', gap: 5 }}>
                                        {passGender.map((gender) => (
                                            <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'gender', gender)} key={gender} style={{ borderColor: '#cf2a3a', borderWidth: 1, width: '50%', borderRadius: 5, justifyContent :'center', paddingVertical: 5 }}>
