        ...
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ paddingHorizontal: 10, paddingTop: 20 }}>
                ...
                {passengers.some(p => p.hasCargo == true) && (
                    <View style={{ borderBottomColor: '#B3B3B3', borderBottomWidth: 1, paddingVertical: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <Text style={{ fontSize: 14, fontWeight: 'bold' }}>₱ {passengers.find(p => p.hasCargo)?.cargo?.cargoFare}.00</Text>
                        </View>
                    </View>
                )}
                <View style={{ borderBottomColor: '#B3B3B3', borderBottomWidth: 1, paddingVertical: 10 }}>
                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, borderBottomColor: '#d8d8d8ff', borderBottomWidth: 1, }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 20, paddingHorizontal: 10, textAlign: 'right', borderBottomColor: '#979797ff', borderBottomWidth: 1, borderRadius: 5 }} />
                        </View>
                    </View>
                </View>
                <View style={{ paddingVertical: 10 }}>
