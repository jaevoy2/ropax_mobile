        ...
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height, }}>
            ...
            <View style={{ padding: 10, marginTop: 20 }}>
                ...
                <View style={{ padding: 10, borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 8 }}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 20, marginBottom: 10 }}>
                        {trips?.map((t) => (
                            <>
                                <TouchableOpacity key={t.trip_id} style={{ backgroundColor: 'transparent', borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 5, borderRadius: 5  }}>
                                    <View>
                                        <Text style={{ fontWeight: 'bold', fontSize: 10, color: '#cf2a3a' }}>{`${t.departure}`}</Text>
                                        <Text style={{ fontWeight: 'bold', fontSize: 10 }}>{`${t.route_origin} > ${t.route_destination} [ ${t.vessel} ]`}</Text>
                                    </View>
                                </TouchableOpacity>
                            </>
                        ))}
