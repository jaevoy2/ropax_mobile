                ...
                <View style={{ backgroundColor: '#00000048', flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: width - 40, backgroundColor: '#fff', borderRadius: 10, justifyContent: 'space-between', padding: 15 }}>
                        ...
                        <View style={{ marginTop: 10 }}>
                            <Text style={{ alignSelf: 'flex-end', fontSize: 10 }}>{itemSelected.departureDate}</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 5, paddingBottom: 8 }}>
                                <Text style={{ fontWeight: 'bold', fontSize: 18 }}>{itemSelected.name}</Text>
                                <Text style={{ fontSize: 12, color: '#cf2a3a', fontWeight: 'bold' }}>{itemSelected.referenceNumber}</Text>
                            </View>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text style={{ fontSize: 10 }}>{`${itemSelected.vessel}  |  ${itemSelected.route}  |  ${itemSelected.departureTime}`}</Text>
