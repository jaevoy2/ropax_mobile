...
export default function Expenses() {
    ...
    const addExpenses = () => {
        setExpenses([]);
        setExpenses(prev => [...prev, { id: 1, trip_schedule_id: 0, description: '', amount: 0, category_id: 0 }]);
                ...
                <View style={{ height: height - 215 }}>
                    <ScrollView>
                        <TouchableOpacity style={{ paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#f3f3f3ff', borderBottomColor: '#FFC1C5', borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <View>
                                <Text style={{ fontWeight: '900', fontSize: 15 , color: '#cf2a3a' }}>Vessel Gasoline</Text>
                                <Text style={{ fontWeight: 'bold', fontSize: 10, color: '#9B9B9B' }}>{date}</Text>
                            </View>
