...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    return (
        <View style={{ height: height }}>
            <ScrollView style={{ height: '40%', backgroundColor: '#000' }}>
                <Animated.View style={{ opacity: tripsAnimation }}> 
                ...
                <Animated.View style={{ paddingHorizontal: 15, paddingTop: 10, transform: [{ translateX: tripsAnimation }], bottom: '105%', minHeight: '100%', top: 0, left: 0, right: 0 }}>
                    {formLoading == true ? (
                        ...
                        <View style={{ paddingTop: 40 }}>
                            ...
                            {cargoOnlyProperty.length > 0 && (
                                <View style={{ flexDirection: 'column', alignItems: 'flex-start', alignSelf: 'flex-end' }}>
                            ...
                            {cargoOnlyProperty.map((c: any) => (
                                <View key={c.id} style={{ borderColor: '#B3B3B3', backgroundColor: '#fff', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <View style={{ flexDirection: 'column', alignItems: formId == 1 ? 'flex-end' : 'flex-start' }}>
