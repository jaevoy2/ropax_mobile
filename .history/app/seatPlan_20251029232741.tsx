            ...
            <View style={{ height: '100%' }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} enablePanDownToClose={true}>
                    <BottomSheetScrollView contentContainerStyle={{ padding: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, padding: 8, width: '100%', marginTop: 5, marginBottom: 10 }}>
                            {passengers.map((p) => (
