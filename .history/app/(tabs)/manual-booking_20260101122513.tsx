    ...
    return (
        <GestureHandlerRootView style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <View>
                ...
                <ScrollView refreshControl={ bookingType == 'Cargo' ? undefined : (<RefreshControl refreshing={refresh} onRefresh={handleRefresh} colors={['#cf2a3a']} progressViewOffset={10} />)} nestedScrollEnabled={true} >
                    {bookingType == 'Walk-In' ? (
