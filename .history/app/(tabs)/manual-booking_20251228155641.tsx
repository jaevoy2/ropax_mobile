    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <View>
                ...
                <ScrollView refreshControl={ <RefreshControl refreshing={refresh} aria-disabled={bookingType == 'Walk-In' ? false : true} onRefresh={handleRefresh} colors={['#cf2a3a']} /> } >
                    {bookingType == 'Walk-In' ? (
                        ...
                        <ScrollView style={{ height: 600, backgroundColor: '#000' }}>
