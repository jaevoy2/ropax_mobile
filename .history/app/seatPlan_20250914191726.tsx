...
export default function SeatPlan() {
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            {isExpanded == true && isFormVisible == false && (
                <TouchableOpacity onPress={() => onFormView()} style={{ position: 'absolute', bottom: 20, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 10, zIndex: 5 }}>
