...
export default function TicketGenerator() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <Text style={{ fontWeight: '600', fontSize: 16, marginLeft: 10, marginTop: 10 }}>Summary</Text>
            <View style={{ padding: 10, backgroundColor: '#fff', borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 10, margin: 10 }}>
