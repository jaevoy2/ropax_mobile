    ...
    return (
        <View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <TextInput placeholder='₱00.00' style={{ borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 5, paddingHorizontal: 15, height: 40 }} />
                    ...
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 10 }}>
                            ...
                            <View>
                                ...
                                <TextInput placeholder='Last Name, First Name' style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, paddingHorizontal: 15, height: 15 }} />
                            </View>
                        </View>
                    ))}
                </ScrollView>
