    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ position: 'relative' }}>
                <View ref={viewRef} style={{ backgroundColor: '#fff', position: 'absolute', top: -70, left: '50%', transform: [{ translateX: '-50%' }], width: '85%', borderRadius: 10, padding: 10 }}>
                    ...
                    <View style={{ paddingVertical: 5, marginTop: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 3 }}>
                            <Text style={{ fontSize: 12, width: 100, fontWeight: '600' }}>Name:</Text>
                            <Text style={{ fontSize: 12, width: 50, fontWeight: '600' }}>Type:</Text>
                            <Text style={{ fontSize: 12, fontWeight: '600' }}>Seat#:</Text>
                        </View>
                        {passengers.map((p) => (
