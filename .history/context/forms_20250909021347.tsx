    ...
    return (
        <View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <View style={{ borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 5, paddingHorizontal: 15, paddingVertical: 5 }}>
            ...
            <View style={{ height: '81%', marginTop: 10 }}>
                <ScrollView>
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, padding: 5, marginBottom: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: '#cf2a3a', borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 20 }}>{p.seatNumber}</Text>
