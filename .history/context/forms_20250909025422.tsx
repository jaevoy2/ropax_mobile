                    ...
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 10 }}>
                            ...
                            <View style={{ marginTop: 10, flexDirection: 'row', gap: 8 }}>
                                <View style={{ height: 40, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, width: '40%' }}>
                                    <TextInput placeholder='Last Name, First Name' style={{ fontSize: 13 }} />
                                </View>
                                <View style={{ width: '50%', flexDirection:'row', gap: 5 }}>
                                    {passGender.map((gender) => (
                                        <TouchableOpacity key={gender} style={{ borderColor: '#cf2a3a', borderWidth: 1, paddingHorizontal: 18, borderRadius: 5, justifyContent :'center' }}>
                                            <Text style={{ textAlign: 'center', fontSize: 12, color: '#cf2a3a' }}>{gender}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
                            </View>
