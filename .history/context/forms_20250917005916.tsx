    ...
    return (
        <View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <View style={{ borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 5, flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                    <Text>₱</Text>
                    <TextInput placeholder='00.00' style={{ paddingHorizontal: 15 }} />
                </View>
