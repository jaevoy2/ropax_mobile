                ...
                <View style={{ padding: 10 }}>
                    {formLoading == true ? (
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', gap: 5, marginTop: 10, width: '100%' }}>
                                {tripTypes.map((type) => (
                                    <TouchableOpacity key={type.name} style={{ paddingVertical: 5, width: '100%', borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 3 }}>
                                        <Text style={{ color: '#cf2a3a', textAlign: 'center' }}>{type.name}</Text>
                                    </TouchableOpacity>
                                ))}
                            </View>
                        </View>
