                            ...
                            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, padding: 8, width: '100%', marginTop: 5 }}>
                                {passengers.map((p) => (
                                    <View key={p.seatNumber} style={{ position: 'relative' }}>
                                        ...
                                        <TouchableOpacity style={{ borderColor: errorForm.includes(p.seatNumber!) ? '#cf2a3a' : '#000', backgroundColor: errorForm.includes(p.seatNumber!) ? '#cf2a3b3d' : p.hasCargo ==  true ? '#ffc10748' : 'transparent', borderWidth: 1, borderRadius: 5, width: 45, height: 45, justifyContent: 'center' }}>
