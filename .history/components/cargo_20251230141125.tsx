...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const getTotalAmount = useMemo(() => {
        return cargoOnlyProperty.reduce(
                ...
                {formLoading == true ? (
                    ...
                    <View style={{ paddingTop: 40 }}>
                        ...
                        {cargoOnlyProperty.length > 1 && (
                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', marginTop: 10, gap: 8, alignSelf: 'flex-end' }}>
                                ...
                                <View style={{ borderBottomColor: '#cf2a3a', borderBottomWidth: 2, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15, paddingVertical: 8 }}>
                                    <Text style={{ fontSize: 16, color: '#cf2a3a', fontWeight: 'bold' }}>₱ </Text>
                                    <Text style={{ fontWeight: 'bold', textAlign: 'right', fontSize: 16, color: '#cf2a3a' }}>
                            ...
                            <View key={c.id} style={{ borderColor: '#B3B3B3', backgroundColor: '#fff', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                                ...
                                {c.id == 1 && (
                                    <View style={{ marginTop: 5 }}>
                                        ...
                                        <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                            <TextInput onChangeText={(text) => updateCargoOnlyProperty(c.id, 'note', text)} placeholder='(Optional)' style={{ fontSize: 13 }} />
                                        </View>
                                    </View>
                                )}
                            </View>
