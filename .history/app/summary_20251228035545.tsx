                    ...
                    <View style={{ borderBottomColor: '#c9c9c9ff', borderBottomWidth: 1, paddingVertical: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <View style={{ width: '80%' }}>
                                ...
                                <View style={{ marginLeft: 15, flexDirection: 'row', gap: 0 }}>
                                    <Text style={{ fontSize: 12, width: '40%', color: '#858585ff' }}>{`${cargoOnlyProperty.cargoBrand} ${cargoOnlyProperty.cargoSpecification}` || cargoOnlyProperty.parcelCategory}</Text>
                                    <Text style={{ fontSize: 12, width: '40%', color: '#858585ff' }}>{`(${cargoOnlyProperty.cargoType})s`}</Text>
                                </View>
                            </View>
