    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <View style={{  position: 'absolute', zIndex: 3, paddingTop: 50, width: width, flex: 1 }}>
                ...
                <View style={{ height: height + 200, paddingTop: 10, }}>
                    <ScrollView>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 10, transform: [{ translateY }], zIndex: 5 }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderRadius: 10, }}>
                    <View style={{flexDirection: 'row', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#f1f1f1', borderRadius: 8, padding: 8, width: '100%', marginTop: 5 }}>
                        {passengers.map((p) => (
                            <View key={p.seatNumber} style={{ position: 'relative' }}>
                                ...
                                <TouchableOpacity style={{ borderColor: '#000', borderWidth: 1, borderRadius: 5, width: 40, height: 40, justifyContent: 'center' }}>
                ...
                <TouchableOpacity onPress={() => onFormView()} style={{ position: 'absolute', bottom: 10, backgroundColor: '#cf2a3a', width: '100%', alignSelf: 'center', borderRadius: 30, paddingVertical: 10 }}>
