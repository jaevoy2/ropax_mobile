...
export default function AddExpenses() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height, }}>
            ...
            <TouchableOpacity style={{ width: '95%', paddingVertical: 16, borderRadius: 60, position: 'absolute', bottom: 0, backgroundColor: '#cf2a3a', transform: [{ translateX: '-50%' }], left: '50%' }}>
                <Text style={{ fontWeight: 'bold', color: '#fff', textAlign: 'center', fontSize: 16 }}>Save</Text>
            </TouchableOpacity>
        </View>
    )
}