    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={seatSheetRef} enableDynamicSizing={true}  snapPoints={animatedSnapPoints as any} index={-1} enableContentPanningGesture={false} handleComponent={null}>
                    ...
                    <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: 10 }}onLayout={handleContentLayout}  showsVerticalScrollIndicator={false}>
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, padding: 8, width: '100%', marginTop: 5, marginBottom: 15 }}>
                            {passengers.map((p) => (
                        ...
                        {isFormVisible == false ? (
                            <TouchableOpacity onPress={() => onFormView()} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15 }}>
                                <Text style={{ fontSize: 16, fontWeight: 'bold', textAlign: 'center', color: '#fff' }}>Continue</Text>
                            </TouchableOpacity>
                        ) : (
                            <TouchableOpacity onPress={() => handleSave()} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15 }}>
                                {saveloading == true ? (
