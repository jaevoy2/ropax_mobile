    ...
    return (
        <GestureHandlerRootView style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                {paxRequestTypes.map((r) => (
                    <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'center', width: '33.33%', alignItems: 'center', gap: 5, paddingVertical: 8, backgroundColor: requestType == r.name ? '#FFC107' : '#ffc1071f'}}>
            ...
            <View style={{ justifyContent: 'center', paddingTop: 20, paddingHorizontal: 20, height: height - 160 }}>
                {loading == true ? (
