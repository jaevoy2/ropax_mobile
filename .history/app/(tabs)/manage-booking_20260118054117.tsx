                    ...
                    <>
                        {passengers.length > 0 ? (
                            <>
                                ...
                                <FlatList refreshing={loading} onRefresh={() => fetchBooking(date, null)} data={passengers.reverse()} keyExtractor={(passengers) => String(passengers.id)} showsVerticalScrollIndicator={false} 
