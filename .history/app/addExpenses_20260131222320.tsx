    ...
    const renderCameraCaptureView = () => {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <TouchableOpacity style={{ position: 'absolute', top: 50, left: 20, zIndex: 5 }} onPress={() => setOnCapture(false)}>
                    <Ionicons name={'chevron-back'} size={28} color="#FFFFFF" />
                </TouchableOpacity>
                
                <View style={{ backgroundImage: '#cf2a3a', position: 'absolute', bottom: 0, height: 100, width: '100%' }}>
