        ...
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 15, transform: [{ translateY }], zIndex: 5 }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderRadius: 10, marginTop: 10, }}>
                    <View style={{flexDirection: 'row', gap: 4, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, padding: 8, width: '100%' }}>
                        {passengers.map((p) => (
                            <View style={{ position: 'relative' }}>
                                <TouchableOpacity style={{ position: 'absolute', top: -10, right: -5, zIndex: 3 }}>
