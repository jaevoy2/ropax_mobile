...
export default function SeatPlan() {
    ...
    const seatSnapPoints = useMemo(() => ["26%", "95%"], []);
        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} bottomInset={1} enableContentPanningGesture={false} handleComponent={null}>
                    ...
                    {isFormVisible == true && (
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', paddingTop: 15, paddingHorizontal: 10 }}>
                    ...
                    <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: 10, paddingTop: 15 }} showsVerticalScrollIndicator={false}>
                        ...
                        {isFormVisible == false ? (
                            <TouchableOpacity onPress={() => onFormView()} disabled={passengers.length == 0} style={{ backgroundColor: passengers.length == 0 ? '#df5a68ff' : '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15 }}>
