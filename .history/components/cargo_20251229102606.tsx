...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const { totalAmount, cargoProperties, cargoOnlyProperty, setCargoProperties, setCargoOnlyProperty, updateCargoOnlyProperty } = useCargo();
