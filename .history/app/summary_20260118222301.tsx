    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ paddingHorizontal: 10, paddingTop: 20 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingBottom: 10, paddingTop: 25, borderBottomColor: '#c9c9c9ff', borderBottomWidth: 1, }}>
                    <Text style={{ fontSize: 12, fontWeight: 'bold', color: '#545454' }}>Cash Tendered:</Text>
                    <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'flex-start', borderColor: '#c9c9c9ff', borderWidth: 1, borderRadius: 5, paddingHorizontal: 5 }}>
