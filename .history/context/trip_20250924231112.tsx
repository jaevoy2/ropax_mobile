...
export const TripProvider = ({ children }: TripProviderProps) => {
    ...
    return (
        <TripContext.Provider value={{ id, trip, origin, destination, vessel_id, totalFare, departure_time, fareChange, code, webCode, cashTendered, refNumber,
                                    setTrip, setID, setOrigin, setDestination, setVesselID, setTotalFare, setDepartureTime, setFareChange, setCode, setWebCode, setCashTendered, setRefNumber, clearTrip }}>
            {children}
