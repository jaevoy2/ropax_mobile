                ...
                <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', height: 160, width: '100%', position: 'absolute', bottom: 0, zIndex: 5, justifyContent: 'center' }}>
                    {capturedImage != null ? (
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                            ...
                            <TouchableOpacity onPress={() => handleOnSaveImage()} style={{ backgroundColor: '#fff', padding: 12, borderRadius: 50 }}>
                                <Ionicons name={'checkmark'} size={28} />
                            </TouchableOpacity>
                        </View>
                    ) : (
                        <TouchableOpacity onPress={() => {handleCaptureImage(), setOnCapture(false)}} style={{ alignSelf: 'center', backgroundColor: '#fff', padding: 12, borderRadius: 50 }}>
