                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 20, paddingHorizontal: 10, textAlign: 'right', borderColor: '#808080ff', borderWidth: 1 }} />
                        </View>
                    </View>
                </View>
                <View style={{ paddingVertical: 10 }}>
