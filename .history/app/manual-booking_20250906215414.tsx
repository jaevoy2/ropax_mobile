...
export default function ManualBooking() {
    ...
    const handleSaveTrip = (trip: string) => {
        setTrip(trip);
        if(refNumber == 0 ) {
            refNumber + 1;
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1' }}>
            ...
            <View style={{ padding: 20 }}>
                ...
                <View>
                    {trips.map((trip) => (
                        <TouchableOpacity onPress={() => handleSaveTrip(trip)} key={trip} style={{ paddingHorizontal: 15, paddingVertical: 25, backgroundColor: '#fff', borderRadius: 10, marginTop: 12 }}>
