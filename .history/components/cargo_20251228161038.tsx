...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, paddingTop: 10,  height: '100%', transform: [{ translateX: tripsAnimation }], bottom: '105%' }}>
                {formLoading == true ? (
                    ...
                    <View style={{ paddingTop: 40 }}>
                        ...
                        {cargoOnlyProperty.length > 0 && (
                            <View style={{ flexDirection: 'column', alignItems: 'flex-start', alignSelf: 'flex-end', marginTop: 10 }}>
