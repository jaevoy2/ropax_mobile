                                                ...
                                                <TouchableOpacity disabled={e.image_uri != null} onPress={() => handleOnCapture(e.id)} style={{ borderColor: '#b3b3b3', borderWidth: 1, borderRadius: 5, height: 90, justifyContent: 'center', position: 'relative' }}>
                                                    {e.image_uri == null ? (
                                                        ...
                                                        <>
                                                            ...
                                                            <View style={{ position: 'absolute', alignSelf: 'center', backgroundColor: '#99999948', height: '100%', width: '100%', justifyContent: 'center', alignContent: 'center' }}>
                                                                <TouchableOpacity style={{ flexDirection: 'row', gap: 3, alignItems: 'center', borderColor: '#fff', borderWidth: 1, padding: 5 }}>
