...
export const CargoProvider = ({ children }: {children: ReactNode}) => {
    ...
    return (
        <CargoContext.Provider value={{ totalAndNote, cargoProperties, paxCargoProperty, updateAmountAndNote, setTotalAndNote, setCargoProperties, setPaxCargoProperties, updateCargoOnlyProperty }}>
            {children}
