                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 18, paddingBottom: -2, paddingLeft: -10, width: 100, textAlign: 'right', borderColor: '#FFC107', borderBottomWidth: 1 }} />
                        </View>
                    </View>
                </View>
