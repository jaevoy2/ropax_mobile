            ...
            <View style={{ padding: 10 }}>
                ...
                {passengers.some(p => p.hasCargo == true) && (
                    <View style={{ borderBottomColor: '#B3B3B3', borderBottomWidth: 1, paddingVertical: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <Text style={{ fontSize: 12, fontWeight: 'bold' }}>Cargo:</Text>
                            <Text style={{ fontSize: 16, fontWeight: '900', color: '#cf2a3a' }}>₱ {passengers.find(p => p.hasCargo)?.cargo?.cargoFare}.00</Text>
                        </View>
                    </View>
                )}
                <View style={{ borderBottomColor: '#B3B3B3', borderBottomWidth: 1, paddingVertical: 10 }}>
