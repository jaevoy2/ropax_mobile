...
export default function TicketGenerator() {
    const { mobileCode, origin, destination, cashTendered, fareChange, totalFare, note, departure_time, refNumber, clearTrip } = useTrip();
            ...
            <View style={{ position: 'relative', height: '80%', top: -70 }}>
                <ScrollView>
                    <View ref={viewRef} style={{ backgroundColor: '#fff', left: '50%', transform: [{ translateX: '-50%' }], width: '85%', borderRadius: 10, padding: 10 }}>
                        ...
                        {note == '' &&(
                            <>
                                <Text style={{ fontSize: 14, fontWeight: '900' }}>NOTE:</Text>
                                <Text>Handle with care.</Text>
                            </>
                        )}
                    </View>
                </ScrollView>
