...
export default function SeatPlan() {
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            {isExpanded == true && isFormVisible == false && (
                <TouchableOpacity onPress={() => onFormView()} style={{ position: 'absolute', bottom: 20, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 10, paddingVertical: 15, zIndex: 5 }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', textAlign: 'center', color: '#fff' }}>Continue</Text>
                </TouchableOpacity>
            )}
            {isFormVisible == true && (
                <TouchableOpacity onPress={() => handleSave()} style={{ position: 'absolute', bottom: 20, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 10, paddingVertical: 15, zIndex: 5 }}>
                    {saveloading == true ? (
