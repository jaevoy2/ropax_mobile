        ...
        <GestureHandlerRootView style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                {paxRequestTypes.map((r) => (
                    <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'center', width: '33.33%', alignItems: 'center', gap: 5, paddingVertical: 10, backgroundColor: requestType == r.name ? '#FFC107' : '#ffc1071f'}}>
                        <MaterialCommunityIcons name={r.icon as any} />
                        <Text>{r.name}</Text>
                    </TouchableOpacity>
                ))}
            </View>
