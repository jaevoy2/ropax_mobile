                ...
                {formLoading == true ? (
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <TouchableOpacity style={{ paddingVertical: 8, paddingHorizontal: 15, borderColor: '#747373ff', borderRadius: 5, borderWidth: 1 }}>
                                <Text style={{ color: '#747373ff', fontWeight: 'bold', fontSize: 15 }}>Change Route</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                )}
