    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View style={{ paddingTop: 50, height: 150, backgroundColor: '#cf2a3a', paddingHorizontal: 20, gap: 15 }}>
                ...
                <View style={{ borderColor: '#cfcfcf73', backgroundColor: '#cfcfcf73', borderWidth: 1, borderRadius: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 10 }}>
                    <TextInput placeholder='Search Booking' placeholderTextColor="#fff" style={{ fontSize: 13, fontWeight: '600', width: '90%', color: '#fff' }} />
                    <TouchableOpacity style={{ borderLeftWidth: 1, borderLeftColor: '#fff', paddingLeft: 10 }}>
                        <Ionicons name={'search'} size={20} color={'#fff'} />
                    </TouchableOpacity>
                </View>
            </View>

            <View style={{ justifyContent: 'center', paddingTop: 20, paddingHorizontal: 20, height: height - 120 }}>
                
                <Text style={{ marginTop: 20, marginBottom: 10, fontWeight: 'bold', fontSize: 20 }}>Bookings</Text>
                <FlatList data={bookings} keyExtractor={(booking) => booking.referenceNumber} showsVerticalScrollIndicator={false} renderItem={({ item }) => (
