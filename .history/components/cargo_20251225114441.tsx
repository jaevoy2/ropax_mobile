...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const handleFetchTrips = async (queryDate: string) => {
        try {
            ...
            const cargoProps = await FetchCargoProps();
            ...
            if(cargoProps) {
                const cargoPropsData = cargoProps.data as CargoProps;

                const cargoTypes = cargoPropsData.data.cargo_types;
                const brands = cargoPropsData.data.brands;
                const parcelCategories = cargoPropsData.data.parcel_categories;
                const specifications = cargoPropsData.data.specifications;
                const cargos = cargoPropsData.data.cargos;
            }
