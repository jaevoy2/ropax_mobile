...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const { totalAndNote, cargoProperties, cargoOnlyProperty, setTotalAndNote, updateAmountAndNote, setCargoProperties, setCargoOnlyProperty, updateCargoOnlyProperty } = useCargo();
    ...
    const getTotalAmount = useMemo(() => {
        const total = cargoOnlyProperty.reduce(
        ...
        setTotalState(total);
        return total;
    }, [cargoOnlyProperty, routeID, cargoProperties]);
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, transform: [{ translateX: tripsAnimation }], position: 'absolute', width, top: 10, }}>
                {formLoading == true ? (
                    ...
                    <View>
                        ...
                        {cargoOnlyProperty.length > 1 && (
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 13, gap: 8, alignSelf: 'flex-end' }}>
                        ...
                        <View style={{ height: height - 350, marginTop: 10 }}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            <View>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                                                    <TouchableOpacity style={{ padding: 5, borderRightColor: '#B3B3B3', borderRightWidth: 1, borderTopLeftRadius: 5, borderBottomLeftRadius: 5  }}>
                                                        <Ionicons name={'remove'} size={20} />
                                                    </TouchableOpacity>
                                                    <Text style={{ padding: 5, borderTopColor: '#B3B3B3', borderBottomColor: '#B3B3B3', borderTopWidth: 1, borderBottomWidth: 1 }}>1</Text>
                                                    <TouchableOpacity style={{ padding: 5, borderRightColor: '#B3B3B3', borderRightWidth: 1, borderTopRightRadius: 5, borderBottomRightRadius: 5  }}>
