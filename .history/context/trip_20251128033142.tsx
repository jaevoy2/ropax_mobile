...
export const TripProvider = ({ children }: TripProviderProps) => {
    ...
    return (
        <TripContext.Provider value={{ id, vessel, origin, destination, vessel_id, totalFare, departure_time, fareChange, code, webCode, mobileCode, cashTendered, refNumber,
                                    setVessel, setID, setOrigin, setDestination, setVesselID, setTotalFare, setDepartureTime, setFareChange, setCode, setWebCode, setMobileCode, setCashTendered, setRefNumber, clearTrip }}>
            {children}
