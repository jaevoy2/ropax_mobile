...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const ComputedCargoAmount = useMemo(() => {
        ...
        cargoOnlyProperty?.cargoType,
        cargoOnlyProperty?.cargoBrandID,
        cargoOnlyProperty?.cargoSpecificationID,
        cargoOnlyProperty?.parcelCategoryID,
        cargoProperties
    ]);
