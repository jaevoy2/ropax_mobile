                                    ...
                                    <View style={{ marginTop: 5, flexDirection: 'row', gap: 8, alignItems: 'flex-end' }}>
                                        ...
                                        <View style={{ width: '72.5%' }}>
                                            ...
                                            <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                                <Dropdown onChange={item => updateExpense(index, 'categoryID', item.value)} value={e.categoryID} data={dropdownCategory} labelField="label" valueField="value" placeholder="Select Category" style={{ height: 40, width: '80%', paddingHorizontal: 10 }}
                                                    containerStyle={{
