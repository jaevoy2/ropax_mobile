...
export default function SeatPlan() {
    ...
    const seatSnapPoints = useMemo(() => ["25%", "85%"], []);
    const passesSnapPoints = useMemo(() => ["50%", "90%"], []);
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1}>
