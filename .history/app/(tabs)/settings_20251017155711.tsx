    ...
    return (
        <View>
            ...
            <View style={{ padding: 10 }}>
                <View style={{ paddingHorizontal: 15, paddingVertical: 25, backgroundColor: '#fff', borderRadius: 10, marginTop: 12, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                        ...
                        {user?.station ? (
                            ...
                            <Text style={{ fontSize: 12, color: '#666' }}>No station selected yet</Text>
                        )}
                    </View>
                </View>
