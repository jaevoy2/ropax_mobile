...
export default function AddExpenses() {
    ...
    const addExpenseForm = () => {
        setExpenses(prev => {
            ...
            return [...prev, { id: lastID + 1, trip_schedule_id: 0, description: '', amount: 0, category_id: 0 }]
        })
    }
                                    ...
                                    <View style={{ marginTop: 5, flexDirection: 'row', gap: 8, alignItems: 'flex-end' }}>
                                        ...
                                        <View style={{ width: '72.5%' }}>
                                            ...
                                            <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                                <Dropdown onChange={item => updateExpense(e.id, 'category_id', item.id)} value={e.category_id || undefined} data={dropdownCategory} labelField="label" valueField="id" placeholder="Select Category" style={{ height: 40, width: '80%', paddingHorizontal: 10 }}
                                                    containerStyle={{
