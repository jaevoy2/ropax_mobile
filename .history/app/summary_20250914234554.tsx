                ...
                <View style={{ backgroundColor: '#fff', borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 10, padding: 10, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'column', gap: 15 }}>
                        ...
                        <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                            ...
                            <View style={{ borderBottomColor: '#FFC107', borderBottomWidth: 1, width: 150, marginTop: -8 }}>
                                <TextInput keyboardType={'numeric'} placeholder='₱00.00' style={{ fontWeight: 'bold', fontSize: 16, paddingVertical: -10 }} />
                            </View>
                        </View>
                    </View>
