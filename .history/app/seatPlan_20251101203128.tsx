            ...
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1} enableContentPanningGesture={false}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', paddingHorizontal: 10 }}>
                        ...
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 5 }} onPress={() => [setPassengers([]), passesSheetRef.current?.close()]}>
