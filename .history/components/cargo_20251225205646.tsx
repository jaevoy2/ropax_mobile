...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    useEffect(() => {
        ...
        console.log(cargoProperties.data.cargos[0].price);

        switch(passengerCargoProps?.cargo?.cargoType) {
            case 'Rolling Cargo':
                if(paxCargoProps.brand != null && paxCargoProps.specification != null) {
                    const amount = cargoProperties.data.cargos.find((cargo: any) => cargo.cargo_type_id == paxCargoProps.cargoTypeID && cargo.cargo_brand_id == paxCargoProps.brandID && cargo.cargo_specification_id == paxCargoProps.specificationID)?.price;
                    updateCargo(0, 'cargoFare', amount);
                }
        }
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                                    ...
                                    <View style={{ borderColor: '#FFC107', backgroundColor: '#ffc10727', borderWidth: 2, borderRadius: 5, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15 }}>
                                        ...
                                        <TextInput onChangeText={(text) => updateCargo(0, 'cargoFare', text)} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', textAlign: 'right' }} />
                                    </View>
                                </View>
                            </View>
