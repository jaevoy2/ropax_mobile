...
export default function ManageBooking() {
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', borderBottomColor: '#FFC107', borderBottomWidth: 1, borderRadius: 100, padding: 10 }}>
                {paxRequestTypes.map((r, index) => (
                    <TouchableOpacity onPress={() => setRequestType(r.name)} key={index} style={{ flexDirection: 'row', justifyContent: 'center', width: '33.33%', alignItems: 'center', gap: 5, paddingVertical: 8,
                        backgroundColor: requestType == r.name ? '#FFC107' : '#ffc1071f', borderRightColor: '#FFC107', borderRightWidth: 1}}>
