    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <TouchableOpacity onPress={() => handlePassesForm()} style={{ position: 'absolute', right: 20, top: 50, zIndex: 1 }}>
                ...
                {!passengers.some((p) => p.passType == 'Passes') && (
                    <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} bottomInset={1}>
                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1} enableContentPanningGesture={false}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }}>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#cf2a3a', borderWidth: 1, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 5 }} onPress={() => [setPassengers([]), passesSheetRef.current?.close()]}>
                            <Ionicons color={'#cf2a3a'} name={'close'} size={23} />
                            <Text style={{ color: '#cf2a3a',fontSize: 14, fontWeight: 'bold'  }}>Close</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#cf2a3a', borderRadius: 5 }}>
