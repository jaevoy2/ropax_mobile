...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const ComputedCargoAmount = useMemo(() => {
        ...
        if(cargo.cargoType == 'Animal/Pet') {
            console.log(cargoProperties.data.cargo_types.find(t => t.name == 'Animal/Pet'))
            return cargoProperties.data.cargos.find(
                c => c.cargo_type_id == cargoProperties.data.cargo_types.find(t => t.name == 'Animal/Pet')
            )?.price ?? '';
        }
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                                    ...
                                    <View style={{ borderColor: '#FFC107', backgroundColor: '#ffc10727', borderWidth: 2, borderRadius: 5, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15 }}>
                                        ...
                                        <TextInput onChangeText={(text) => {updateCargo(0, 'cargoFare', text)}} value={ComputedCargoAmount ? String(ComputedCargoAmount) : ''} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', textAlign: 'right' }} />
                                    </View>
                                </View>
                            </View>
