        ...
        switch(passengerCargoProps?.cargo?.cargoType) {
            case 'Rolling Cargo':
                if(paxCargoProps.brand != null && paxCargoProps.specification != null) {
                    const amount = cargoProperties.data.cargos.find((cargo: any) => cargo.cargoTypeID == paxCargoProps.cargoTypeID && cargo.cargoBrandID == paxCargoProps.brandID && cargo.cargoSpecsID == paxCargoProps.specificationID).cargoPrice;
