                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', width: 90, gap: 4, justifyContent: 'center' }}>
                    ...
                    {seatColumn1.map((seat) =>{
                        ...
                        return ( 
                            ...
                            backgroundColor: 
                                booked ? booked.station.color : isPassenger ? '#BA68C8' : seat == 'A' || seat == 'B' && !seatSelectionChannel.includes(seat) ? '#E6E2C6' : seatSelectionChannel.includes(seat) ? '#e6d1e9ff' : 'transparent'
                            }}> 
