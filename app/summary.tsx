...
export default function PaymentSummary() {
    ...
    return (
        <View style={{ flexDirection: 'column', justifyContent: 'space-between', backgroundColor: '#fafafa', flex: 1, paddingBottom: insets.bottom }}>
                        ...
                        <ScrollView style={{ flex: 1 }}>
                            <View style={{ paddingHorizontal: 10 }}>
                                <View style={{ borderColor: "#dadada", borderWidth: 1, borderRadius: 8 }}>
                                    {passengers.length > 0 ? (
                                        <>
                                            <Text style={{ padding: 10, fontSize: 17, borderBottomColor: '#dadada', borderBottomWidth: 1, fontWeight: 'bold' }}>Passenger/s</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, paddingHorizontal: 10, paddingVertical: 12, backgroundColor: '#cf2a3b27', borderBottomRightRadius: 6, borderBottomLeftRadius: 6 }}>
                                        ...
                                        <Text style={{ fontSize: 18, fontWeight: '800', color: '#cf2a3a' }}>₱ {totalFare.toFixed(2)}</Text>
                                    </View>
                                </View>
                            </View>
                        </ScrollView>
            ...
            <TouchableOpacity onPress={() => handleConfirmation()} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 8, paddingVertical: 15, zIndex: 5 }}>
                {loading == true ? (
