            ...
            <Animated.View style={{ paddingHorizontal: 15, paddingTop: 10, backgroundColor: '#f1f1f1', height: '100%', transform: [{ translateX: tripsAnimation }], bottom: '105%' }}>
                {formLoading == true ? (
                    ...
                    <View>
                        ...
                        {cargoOnlyProperty.map((c: any, index) => (
                            <View key={index} style={{ borderColor: '#B3B3B3', backgroundColor: '#fff', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                                        ...
                                        { c?.cargoType == 'Rolling Cargo' ? (
                                            <>
                                                <View style={{ marginTop: 10 }}>
                                                    ...
                                                    <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                                        <Dropdown onChange={(item) => {updateCargoOnlyProperty(index, c.cargoTypeID, 'cargoBrand', item.label), updateCargoOnlyProperty(index, c.cargoTypeID, 'cargoBrandID', item.value), setSelectdBrand(item.value)}} value={selectedBrand} data={cargoProperties?.data.brands.map((b: any) => ({ label: b.name, value: b.id }))} labelField="label" valueField="value" placeholder="Select Brand" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                                            containerStyle={{
                                                                alignSelf: 'flex-start',
                                                                width: '85%',
                                                            }}
                                                ...
                                                <View style={{ marginTop: 5, flexDirection: 'row', justifyContent: 'space-between' }}>
                                                    <View style={{ width: '48%' }}>
                                                        ...
                                                        <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                                            <Dropdown onChange={(item) => {updateCargoOnlyProperty(index, c.cargoTypeID, 'cargoSpecification', item.label), updateCargoOnlyProperty(index, c.cargoTypeID, 'cargoSpecificationID', item.value), setSelectedCC(item.value)}} value={selectedCC} data={cargoProperties?.data.specifications.map((specs: any) => ({ label: specs.cc, value: specs.id }))} labelField="label" valueField="value" placeholder="Select CC" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                                                containerStyle={{
                                                                    alignSelf: 'flex-start',
                                                                    width: '40%',
                                                                }}
                                                    ...
                                                    <View style={{ width: '48%' }}>
                                                        ...
                                                        <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, paddingVertical: 1 }}>
                                                            <TextInput onChangeText={(text) => updateCargoOnlyProperty(index, c.cargoTypeID, 'cargoPlateNo', text)} placeholder='Plate#' style={{ fontSize: 13 }} />
                                                        </View>
                                                    </View>
                                                </View>
                                            </>
