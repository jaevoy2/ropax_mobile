...
type CargoContextType = {
    ...
    cargoOnlyProperty: CargoOnlyProperties | null;
    setCargoOnlyProperty: React.Dispatch<React.SetStateAction<CargoOnlyProperties | null>>
...
export const CargoProvider = ({ children }: {children: ReactNode}) => {
    ...
    const [cargoOnlyProperty, setCargoOnlyProperty] = useState<CargoOnlyProperties | null>(null);
    ...
    return (
        <CargoContext.Provider value={{ cargoProperties, setCargoProperties, cargoOnlyProperty, setCargoOnlyProperty, updateCargoOnlyProperty }}>
            {children}
