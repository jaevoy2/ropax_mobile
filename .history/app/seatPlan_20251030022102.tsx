        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} bottomInset={1} enableContentPanningGesture={false} handleComponent={null}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, paddingHorizontal: 8, width: '100%', marginTop: 5, marginBottom: 15 }}>
                            {passengers.map((p) => (
