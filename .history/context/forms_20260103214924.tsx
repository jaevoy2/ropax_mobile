    ...
    const hasCargoChecker = useCallback((seat, passIndex) => {
        ...
        setPassengers(prev => 
            prev.map((p, index) => {
                ...
                return {
                    ...p, hasCargo: isHasCargo, cargo: isHasCargo ? [{ cargoFare: '' }] : []
                }
            })
        )
    }, []);
