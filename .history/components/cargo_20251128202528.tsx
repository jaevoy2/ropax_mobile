...
export default function CargoComponent() {
    ...
    const tripsAnimation = useRef(new Animated.Value(width + 200)).current;
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, backgroundColor: '#f1f1f1', height: '100%', transform: [{ translateX: tripsAnimation }] }}>
                {formLoading == true ? (
