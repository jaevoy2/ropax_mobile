                                    ...
                                    {typeLoading == true ? (
                                        ...
                                        <>
                                            {passengerType?.filter((t) => t.name != 'Infant' && t.name != 'Passes')
                                                .map((type) => (
                                                <TouchableOpacity onPress={() => {updatePassenger(index, p.seatNumber, 'passType', type.name), updatePassenger(index, p.seatNumber, 'passType_id', type.id), getPassengerFare(type.id, p.accommodationID!, p.seatNumber!), updatePassenger(index, p.seatNumber!, 'passTypeCode', type.code)}}
