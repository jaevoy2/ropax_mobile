                    ...
                    {formLoading == true ? (
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10, width: '100%', justifyContent: 'space-between' }}>
                                {tripTypes.map((type) => (
                                    <TouchableOpacity onPress={() => setTripType(type.name)} key={type.name} style={{ paddingVertical: 5, width: '49%', borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 3, backgroundColor: tripType == type.name ? '#cf2a3a' : 'transparent' }}>
                                        <Text style={{ color: tripType == type.name ? '#fff' : '#cf2a3a', textAlign: 'center' }}>{type.name}</Text>
                                    </TouchableOpacity>
                                ))}
                            </View>
                        </View>
