                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }}>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#cf2a3a', borderRadius: 5 }}>
                            ...
                            <Text style={{ color: '#fff',fontSize: 13, fontWeight: 'bold'  }}>Add Passes</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }} onPress={() => [setPassengers([]), passesSheetRef.current?.close()]}>
                            <Ionicons color={'#cf2a3a'} name={'close'} size={30} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginVertical: 15, paddingHorizontal: 10 }}>
                        <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
