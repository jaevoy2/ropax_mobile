...
export default function AddExpenses() {
    ...
    const renderCameraCaptureView = () => {
        ...
        return (
            <View style={{ flex: 1 }}>
                <CameraView ref={cameraRef} style={{ height: height - 150 }} facing='back' />
                ...
                <TouchableOpacity style={{ position: 'absolute', top: 50, left: 20, zIndex: 5, backgroundColor: '#cf2a3a', padding: 8, borderRadius: 50 }} onPress={() => setOnCapture(false)}>
                    <Ionicons style={{ right: 2 }} name={'chevron-back'} size={28} color="#FFFFFF" />
                </TouchableOpacity>
                
                <View style={{ backgroundColor: '#cf2a3a', flex: 1 }}>
