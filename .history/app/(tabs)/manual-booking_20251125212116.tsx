                            ...
                            {trips && trips?.length > 0 ? (
                                <>
                                    ...
                                    <View style={{ marginTop: 20 }}>
                                        <Text style={{ fontWeight: 'bold', fontSize: 18, color: '#cf2a3a', marginBottom: 10, textAlign: 'right',  borderBottomColor: '#b4b4b4ff', borderBottomWidth: 1 }}>30 TOTAL PAYING PASSENGERS</Text>
                                        <View style={{ gap: 15 }}>
