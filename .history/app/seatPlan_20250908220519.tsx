...
export default function SeatPlan() {
    ...
    const toggleSheetPartial = () => {
        const toValue = isExpanded ? height: height - 180;
        ...
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 10, transform: [{ translateY }], zIndex: 5 }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderRadius: 10, }}>
                    <View style={{flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#f1f1f1', borderRadius: 8, padding: 8, width: '100%', marginTop: 5 }}>
                        {passengers.map((p) => (
