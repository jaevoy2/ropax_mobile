                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, borderBottomColor: '#c9c9c9ff', borderBottomWidth: 1, }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ padding: 10, fontWeight: 'bold', fontSize: 17, paddingHorizontal: 10, textAlign: 'right', borderBottomColor: '#979797ff', borderBottomWidth: 1, borderRadius: 5 }} />
                        </View>
                    </View>
                </View>
                <View style={{ paddingVertical: 10 }}>
