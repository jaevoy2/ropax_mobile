...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const { totalAndNote, cargoProperties, paxCargoProperty, setTotalAndNote, updateAmountAndNote, setCargoProperties, setPaxCargoProperties, updateCargoOnlyProperty } = useCargo();
    ...
    const addCargo = () => {
        ...
        setFormId(form_id);
        setPaxCargoProperties(prev => [...prev, { id: form_id, quantity: 2 }]);
    }
    ...
    const ComputedCargoAmount = (cargo: PaxCargoProperties) => {
        ...
        if(cargo?.cargoType == 'Parcel') {
            ...
            amount = Number(cargoProperties.data.cargo_options?.find(
                c => 
    ...
    const handleCargoQuantity = (operation: string) => {
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            {c.cargoType && c.cargoType != 'Rolling Cargo' && (
                                                <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                                                    <Text style={{ fontSize: 10, fontWeight: 'bold', color: '#545454' }}>{c.quantity}</Text>
