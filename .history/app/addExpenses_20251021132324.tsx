                        ...
                        {trips?.map((t) => (
                            <>
                                <TouchableOpacity key={t.trip_id} style={{ backgroundColor: 'transparent', borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 5, borderRadius: 5  }}>
                                    <View>
                                        <Text style={{ fontWeight: 'bold', fontSize: 8, color: '#cf2a3a' }}>{`${t.departure}`}</Text>
                                        <Text style={{ fontWeight: 'bold', fontSize: 8 }}>{`${t.route_origin}  >  ${t.route_destination} [ ${t.vessel} ]`}</Text>
                                    </View>
                                </TouchableOpacity>
                            </>
                        ))}
