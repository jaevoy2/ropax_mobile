    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ paddingVertical: 15 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#cf2a3b38', borderBottomColor: '#CF2A3A', borderBottomWidth: 1, paddingBottom: 10, paddingHorizontal: 15 }}>
