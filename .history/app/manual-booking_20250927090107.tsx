...
export default function ManualBooking() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <Animated.View style={{ height, position: 'absolute', bottom: 0, backgroundColor: '#fff', width: width, transform: [{ translateY }], borderTopRightRadius: 10, borderTopLeftRadius: 10 }}>
                <View>
                    <Text>lol</Text>
                </View>
            </Animated.View>
