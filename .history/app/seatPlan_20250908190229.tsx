        ...
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <View style={{  position: 'absolute', zIndex: 3, paddingTop: 50, width: width, flex: 1 }}>
                ...
                <View style={{ height: '50%', paddingTop: 10, }}>
                    <ScrollView>
                        <Image source={deck} style={{ opacity: 0.5, width: '100%', marginLeft: -3, height: height + 650 }} />
                        <View style={{ height: 300, width: '90%', zIndex: 5, position: 'absolute', left: '50%', transform: [{ translateX: '-50%' }], alignItems: 'center', }}>
                            ...
                            <View style={{ width: '85%', backgroundColor: '#FAFAFA', marginTop: 10, borderRadius: 10, paddingVertical: 30, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#fff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 15, transform: [{ translateY }], zIndex: 5 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
                        ...
                        <Text style={{ color: '#cf2a3a', fontSize: 12, fontWeight: 'bold' }}>Change Seat</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, borderRadius: 10, marginTop: 10, }}>
                    <View style={{flexDirection: 'row', gap: 8, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, padding: 8, width: '100%' }}>
                        {passengers.map((p) => (
                            <View style={{ position: 'relative' }}>
                                <TouchableOpacity style={{ position: 'absolute', top: -8, right: -4, zIndex: 3 }}>
                                    <Ionicons name="remove-circle" size={20} color={'#cf2a3a'} />
                                </TouchableOpacity>
                                <TouchableOpacity key={p.seatNumber} style={{ borderColor: '#000', borderWidth: 1, borderRadius: 5, width: 40, height: 40, justifyContent: 'center' }}>
                                    <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 18 }}>{p.seatNumber}</Text>
                                </TouchableOpacity>
                            </View>
                        ))}
                    </View>
                </View>
                <TouchableOpacity style={{ backgroundColor: '#cf2a3a', width: '100%', alignSelf: 'center', borderRadius: 30, paddingVertical: 10 }}>
                    <Text style={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center', color: '#fff' }}>Continue</Text>
                </TouchableOpacity>
            </Animated.View>
