    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ paddingVertical: 15 }}>
                ...
                <TouchableOpacity style={{ paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#f1f1f1', borderRadius: 10, borderBottomColor: '#FFC1C5', borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View>
