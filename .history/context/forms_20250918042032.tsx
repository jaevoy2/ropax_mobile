        ...
        <View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <View style={{ borderColor: '#cf2a3a', backgroundColor: '#cf2a3b1a', borderWidth: 2, borderRadius: 5, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 15 }}>
                    ...
                    <TextInput value={String(totalFare != 0 ? totalFare : 0)} onChangeText={(text) => setTotalFAre(Number(text))} placeholder='00.00' style={{ fontWeight: 'bold' }} keyboardType={'numeric'} />
                </View>
