                            ...
                            <>
                                ...
                                <View style={{ flexDirection: 'column', gap: 8, marginTop: 10 }}>
                                    {stationOptions?.map((option) => (
                                        <TouchableOpacity onPress={() => setSelectedStation(option.id)} key={option.id} style={{ paddingHorizontal: 8, paddingVertical: 10, borderWidth: 1, borderColor: '#cf2a3a', borderRadius: 5, backgroundColor: selectedStation ? '#cf2a3a' : '#cf2a3b2d' }}>
                                            <Text style={{ fontWeight: 'bold', color: selectedStation ? '#fff' : '#cf2a3a' }}>{option.name}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
