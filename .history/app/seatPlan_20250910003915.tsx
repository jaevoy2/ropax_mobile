...
export default function SeatPlan() {
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            ...
            if (hasEmpty) {
                ...
                Alert.alert('Invalid', `The seat number ${hasEmpty.seatNumber} required field is missing.`);
            }
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            {isFormVisible == true && (
                <TouchableOpacity onPress={() => setSaveLoading(true)} style={{ position: 'absolute', bottom: 10, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 10, zIndex: 5 }}>
                    {saveloading == true ? (
