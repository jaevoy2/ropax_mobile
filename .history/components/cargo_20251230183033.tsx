                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            <View>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#B3B3B3', paddingHorizontal: 5, borderWidth: 1, borderRadius: 5 }}>
                                                    ...
                                                    <Text style={{ paddingHorizontal: 8, borderRightColor: '#B3B3B3', borderLeftColor: '#B3B3B3', borderLeftWidth: 1, borderRightWidth: 1, paddingVertical: 5, paddingRight: 8 }}>1</Text>
                                                    <TouchableOpacity>
