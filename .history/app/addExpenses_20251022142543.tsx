...
export default function AddExpenses() {
    ...
    const addExpenseForm = () => {
        setExpenses(prev => {
            ...
            return [...prev, { id: lastID + 1, trip_id: 0, description: '', amount: 0, categoryID: 0 }]
        })
    }
                ...
                <View style={{ flex: 1, flexGrow: 1 }}>
                    <View style={{ minHeight: height - 350, maxHeight: height - 300, marginTop: 10 }}>
                        <ScrollView style={{ maxHeight: height - 300 }} contentContainerStyle={{ minHeight: height - 350 }}>
                            {expenses.map((e) => (
                                <View key={e.id} style={{ padding: 10, marginTop: 15, borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 8 }}>
                                    {e.id !== 1 && (
                                    ...
                                    <View style={{ marginTop: 5, flexDirection: 'row', gap: 8, alignItems: 'flex-end' }}>
                                        ...
                                        <View style={{ width: '72.5%' }}>
                                            ...
                                            <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                                <Dropdown onChange={item => updateExpense(e.id, 'categoryID', item.value)} value={e.categoryID || undefined} data={dropdownCategory} labelField="label" valueField="id" placeholder="Select Category" style={{ height: 40, width: '80%', paddingHorizontal: 10 }}
                                                    containerStyle={{
