    ...
    return (
        <View>
            ...
            <View style={{ height: '81%', marginTop: 10 }}>
                <ScrollView>
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 10, marginBottom: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: '#cf2a3a', borderColor: '#cf2a3a', backgroundColor: '#cf2a3b1a', borderWidth: 1, paddingVertical: 8, paddingHorizontal: 25, borderRadius: 5 }}>
                                    {p.seatNumber}
                                </Text>
