                ...
                {isFormVisible == true && (
                    <View style={{ paddingVertical: 10, position: 'relative' }}>
                        ...
                        {isExpanded == true && isPassFormVisible != true  && (
                            <TouchableOpacity onPress={() => onFormView()} style={{ position: 'absolute', top: 10, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15, zIndex: 5 }}>
