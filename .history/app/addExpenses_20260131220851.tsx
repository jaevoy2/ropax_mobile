        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 60 }}>
                    <TouchableOpacity style={{ position: 'absolute', top: 50, left: 20, zIndex: 5, backgroundColor: '#cf2a3a', borderRadius: 50, padding: 5 }} onPress={() => setOnCapture(false)}>
                         <Ionicons style={{ alignSelf: 'center' }} name={'chevron-back'} size={28} color="#FFFFFF" />
                    </TouchableOpacity>
