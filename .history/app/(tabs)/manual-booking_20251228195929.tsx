...
export default function ManualBooking() {
    const { id, vessel, setVessel, setID, setOrigin, setDestination, setVesselID, setCode, setWebCode, setDepartureTime, setMobileCode } = useTrip();
            ...
            <View>
                ...
                <ScrollView refreshControl={ <RefreshControl refreshing={refresh} onRefresh={handleRefresh} colors={['#cf2a3a']} progressViewOffset={180} />} nestedScrollEnabled={true} >
                    {bookingType == 'Walk-In' ? (
                        ...
                        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, paddingBottom: 100 }}>
                            <ScrollView style={{ height: 400 }} contentContainerStyle={{ paddingBottom: 500 }} keyboardShouldPersistTaps="handled" nestedScrollEnabled={true}>
