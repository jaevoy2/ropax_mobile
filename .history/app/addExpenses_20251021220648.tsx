...
export default function AddExpenses() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height, }}>
            {/* add category modal */}
            ...
            <TouchableOpacity style={{ width: '95%', paddingVertical: 10, borderRadius: 60, position: 'absolute', bottom: 50 }}>
