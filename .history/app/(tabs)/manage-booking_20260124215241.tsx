...
export default function ManageBooking() {
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
            ...
            <View style={{ paddingTop: 50, height: 140, backgroundColor: '#cf2a3a', paddingHorizontal: 20, gap: 15 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                {paxRequestTypes.map((r, index) => (
                    <TouchableOpacity key={index} style={{ flexDirection: 'row', justifyContent: 'center', width: '33.33%', alignItems: 'center', gap: 5, paddingVertical: 8, backgroundColor: requestType == r.name ? '#FFC107' : '#ffc1071f'}}>
