        ...
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <View style={{  position: 'absolute', zIndex: 3, paddingTop: 50, width: width, flex: 1 }}>
                ...
                <View style={{ height: '50%', paddingVertical: 20 }}>
                    <ScrollView>
                        <Image source={deck} style={{ opacity: 0.5, width: '100%' }} />
                        <View style={{ height: 300, width: '90%', zIndex: 5, position: 'absolute', left: '48%', transform: [{ translateX: '-50%' }], alignItems: 'center', }}>
