                ...
                <View style={{ height: '50%', paddingVertical: 20 }}>
                    <ScrollView>
                        ...
                        <View style={{ height: 300, width: '90%', zIndex: 5, position: 'absolute', left: '50%', transform: [{ translateX: '-50%' }], alignItems: 'center', }}>
                            ...
                            <View style={{ width: '85%', backgroundColor: '#fff', marginTop: 20, borderRadius: 10, paddingVertical: 30, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'row', gap: 3, alignItems: 'center' }}>
                                    <Ionicons name={'boat'} size={17} color={'#fff'} style={{ padding: 3, backgroundColor: '#cf2a3a', borderRadius: 5 }} />
                                    <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{trip.split(" ")[0]}</Text>
                                </View>
                                <Text>{trip.split(" ")[4]}</Text>
                            </View>
                        </View>
                    </ScrollView>
                </View>
