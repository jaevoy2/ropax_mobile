                                ...
                                <>
                                    ...
                                    <View style={{ marginTop: 5, flexDirection: 'row', gap: 8, alignItems: 'flex-end' }}>
                                        ...
                                        <View style={{ width: '56%', }}>
                                            ...
                                            <View style={{ flexDirection:'row', gap: 5 }}>
                                                {passGender.map((gender) => (
                                                    <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'infantGender', gender)} key={gender} style={{ backgroundColor: p.infantGender = gender ? '#cf2a3a' : 'transparent', borderColor: '#cf2a3a', borderWidth: 1, width: '50%', borderRadius: 5, justifyContent :'center', paddingVertical: 8 }}>
                                                        <Text style={{ textAlign: 'center', fontSize: 14, color: p.infantGender == gender ? '#cf2a3a' : '#cf2a3a' }}>{gender}</Text>
                                                    </TouchableOpacity>
                                                ))}
                                            </View>
                                        </View>
