...
export default function SeatPlan() {
    ...
    const seatSnapPoints = useMemo(() => {
        if(passengers.length == 0) return ["0.1%"];
        if(containerHeight == 0 && passengers.length > 0) return ["26%"];
        const containerPercent = (containerHeight / height) * 100 + 5;
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={0} bottomInset={1} enableContentPanningGesture={false} handleComponent={null}>
