                        ...
                        <View style={{ borderColor: '#B3B3B3', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                            ...
                            <View style={{ marginTop: 5, flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View style={{ width: '50%' }}>
                                    ...
                                    <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                        <Dropdown onChange={(item) => {updateCargo(0, 'cc', item.value), setSelectedCC(item.value)}} value={selectedCC} data={formattedCCs} labelField="label" valueField="value" placeholder="Specification" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                            containerStyle={{
                                                alignSelf: 'flex-start',
                                                width: '42%',
                                            }}
