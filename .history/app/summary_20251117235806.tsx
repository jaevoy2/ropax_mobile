    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ padding: 10 }}>
                ...
                <View style={{ borderBottomColor: '#B3B3B3', borderBottomWidth: 1, paddingBottom: 15 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 3, marginTop: 10 }}>
                        <Text style={{ fontSize: 13, width: '40%' }}>Name:</Text>
                        <Text style={{ fontSize: 13, width: 60, textAlign: 'right' }}>Fare</Text>
                    </View>
