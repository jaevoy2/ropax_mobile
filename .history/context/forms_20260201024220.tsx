...
export default function Forms({ errorForm }: FormProps) {
    ...
    const handlePaxFare = (passenger: PassengerProps) => {
                                    ...
                                    {typeLoading == true ? (
                                        ...
                                        <>
                                            {passengerType?.filter((t) => t.name != 'Infant' && t.name != 'Passes')
                                                .map((type) => (
                                                <TouchableOpacity onPress={() => {handlePaxFare(p), updatePassenger(index, p.seatNumber, 'passType', type.name), updatePassenger(index, p.seatNumber, 'passType_id', type.id), updatePassenger(index, p.seatNumber!, 'passTypeCode', type.code)}}
