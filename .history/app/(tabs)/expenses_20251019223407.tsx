    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ paddingVertical: 15 }}>
                ...
                <TouchableOpacity style={{ paddingHorizontal: 15, paddingVertical: 10, backgroundColor: '#f1f1f1', borderRadius: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View>
