            ...
            <Animated.View style={{ height, position: 'absolute', bottom: 0, backgroundColor: '#fff', width: width, transform: [{ translateY: sheetTranslateY }], borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                <View style={{ padding: 10 }}>
                    {formLoading == true ? (
                        ...
                        <>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', borderBottomColor: '#8f8f8fff', borderBottomWidth: 1, paddingBottom: 5 }}>
                                <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Cargo Form</Text>
                                <TouchableOpacity onPress={() => closeFormSheet()} style={{ alignSelf:'flex-end' }}>
