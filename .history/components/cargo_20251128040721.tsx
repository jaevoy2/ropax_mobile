                    ...
                    {formLoading == true ? (
                        ...
                        <>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', borderBottomColor: '#8f8f8fff', borderBottomWidth: 1, paddingBottom: 10 }}>
                                <View>
                                    <Text style={{ color: '#747373ff', fontSize: 10 }}>Vessel</Text>
                                    <View style={{ flexDirection: 'row', alignItems: 'flex-end', gap: 3 }}>
                                        <Text style={{ color: '#cf2a3a', fontSize: 18, fontWeight: 'bold' }}>{selectedVessel}</Text>
                                        <Text style={{ color: '#747373ff', fontSize: 13 }}>{timeWithRoute}</Text>
                                    </View>
                                </View>
