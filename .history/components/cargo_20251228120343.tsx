...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, paddingTop: 10, backgroundColor: '#f1f1f1', height: '100%', transform: [{ translateX: tripsAnimation }],position: 'absolute', bottom: 0, top: 0, left: 0, right: 0 }}>
                {formLoading == true ? (
