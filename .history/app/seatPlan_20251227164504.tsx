    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <TouchableOpacity disabled={passengers.length > 0 && passengers.some(p => p.hasCargo == false)} onPress={() => handlePassesForm()} style={{ position: 'absolute', right: 20, top: 50, zIndex: 1 }}>
