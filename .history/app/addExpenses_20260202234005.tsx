...
export default function AddExpenses() {
                ...
                <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', height: 160, width: '100%', position: 'absolute', bottom: 0, zIndex: 5, justifyContent: 'center' }}>
                    {capturedImage != null ? (
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                            ...
                            <TouchableOpacity onPress={() => {handleOnSaveImage(), setOnCapture(false), console.log(expenses.some(e => e.image_uri != null))}} style={{ backgroundColor: '#fff', padding: 12, borderRadius: 50 }}>
    ...
    const handleOnSaveImage = async () => {
        ...
        updateExpense(expenseID, 'image_uri', imageUri);
                                    ...
                                    {expenses.map((e) => (
                                        <View key={e.id} style={{ padding: 10, marginTop: 15, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, backgroundColor: '#fff' }}>
                                            ...
                                            <View style={{ marginTop: 5 }}>
                                                ...
                                                <TouchableOpacity onPress={() => handleOnCapture(e.id)} style={{ borderColor: '#b3b3b3', borderWidth: 1, borderRadius: 5, height: 60 }}>
                                                    {e.image_uri == null ? (
                                                        ...
                                                        <Image source={{ uri: e.image_uri }} resizeMode={'cover'} style={{ width: '100%', height: '100%' }} />
                                                    )}
                                                </TouchableOpacity>
                                            </View>
                                        </View>
