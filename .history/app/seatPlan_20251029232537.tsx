            ...
            <View style={{ height: '100%' }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} enablePanDownToClose={true}>
                    <BottomSheetScrollView contentContainerStyle={{ padding: 10 }}>
                        ...
                        {isFormVisible == false ? (
                            <TouchableOpacity onPress={() => setIsFormVisible(true)} style={{ position: 'absolute', bottom: 10, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15, zIndex: 5 }}>
