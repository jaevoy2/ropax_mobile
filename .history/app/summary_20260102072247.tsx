            ...
            <View style={{ paddingHorizontal: 10, paddingTop: 20 }}>
                ...
                <View style={{ borderBottomColor: '#c9c9c9ff', borderBottomWidth: 1, paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
                            <Text style={{ fontSize: 16, color: '#858585ff' }}>₱ </Text>
                            <Text style={{ fontSize: 16, fontWeight: '900', color: '#cf2a3a' }}>
                                {!totalAndNote.totalAmount ? totalFare.toLocaleString('en-PH', { minimumFractionDigits: 2,  maximumFractionDigits: 2}) : totalAndNote.totalAmount.toLocaleString('en-PH', { minimumFractionDigits: 2,  maximumFractionDigits: 2})}
                            </Text>
                        </View>
                    </View>
                </View>
