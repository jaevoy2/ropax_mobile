                                    ...
                                    <View key={c.id} style={{ borderColor: '#B3B3B3', backgroundColor: '#fff', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                                        ...
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                            ...
                                            <View>
                                                ...
                                                <View style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#B3B3B3', padding: 5, borderWidth: 1, borderRadius: 5 }}>
                                                    <TouchableOpacity>
                                                        <Ionicons name={'remove'} size={20} />
                                                    </TouchableOpacity>
                                                    <Text style={{ paddingHorizontal: 8, borderRightColor: '#B3B3B3', borderLeftColor: '#B3B3B3', borderLeftWidth: 1, borderRightWidth: 1 }}>1</Text>
                                                    <TouchableOpacity>
