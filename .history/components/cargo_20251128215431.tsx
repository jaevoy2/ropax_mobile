...
export default function CargoComponent() {
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, backgroundColor: '#f1f1f1', height: '100%', width: width, transform: [{ translateX: tripsAnimation }], top: -215 }}>
                {formLoading == true ? (
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                            <View style={{ alignSelf: 'flex-end', flexDirection: 'column', alignItems: 'flex-end' }}>
