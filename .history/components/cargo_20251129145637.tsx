        ...
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ paddingHorizontal: 15, paddingTop: 25, backgroundColor: '#f1f1f1', height: '100%', transform: [{ translateX: tripsAnimation }], bottom: '105%' }}>
                {formLoading == true ? (
                    ...
                    <View>
                        <TouchableOpacity onPress={() => closeFormSheet()} style={{ flexDirection: 'row', alignItems: 'center', gap: 5, paddingVertical: 8, paddingHorizontal: 10, backgroundColor: '#cf2a3a', borderRadius: 5, alignSelf: 'flex-start' }}>
