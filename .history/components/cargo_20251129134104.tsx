                    ...
                    <View>
                        ...
                        <View style={{ borderColor: '#B3B3B3', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 25 }}>
                            ...
                            <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                    <Dropdown onChange={(item) => setSelectdBrand(item.value)} value={selectedBrand} data={formattedBrands} labelField="label" valueField="id" placeholder="Select Category" style={{ height: 40, width: '80%', paddingHorizontal: 10 }}
                                        containerStyle={{
