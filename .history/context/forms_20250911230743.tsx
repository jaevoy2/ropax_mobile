    ...
    return (
        <View>
            ...
            <View style={{ height: '81%', marginTop: 10 }}>
                <ScrollView>
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: errorForm == p.seatNumber ? '#cf2a3a' : '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 20 }}>
                            ...
                            <View style={{ marginTop: 5, flexDirection: 'row', gap: 8 }}>
                                <View style={{ width: '60%' }}>
                                    ...
                                    <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                        <TextInput placeholder='+63' onChangeText={(text) => updatePassenger(p.seatNumber!, 'nationality', text)} style={{ fontSize: 13 }} />
                                    </View>
                                </View>
                            </View>
                                        ...
                                        <View style={{ width: '56%', }}>
                                            ...
                                            <View style={{ flexDirection:'row', gap: 5 }}>
                                                {passGender.map((infntgender) => (
                                                    <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'infantGender', infntgender)} key={infntgender} style={{ backgroundColor: p.infantGender == infntgender ? '#cf2a3a' : 'transparent', borderColor: '#cf2a3a', borderWidth: 1, width: '50%', borderRadius: 5, justifyContent :'center', paddingVertical: 8 }}>
