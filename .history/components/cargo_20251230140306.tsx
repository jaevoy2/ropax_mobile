                ...
                {formLoading == true ? (
                    ...
                    <View style={{ paddingTop: 40 }}>
                        ...
                        {cargoOnlyProperty.length > 1 && (
                            <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', alignSelf: 'flex-end', marginTop: 10 }}>
                                <Text style={{ fontWeight: 'bold', color: '#545454', fontSize: 18 }}>Total:</Text>
