...
export default function CargoComponent() {
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ opacity: formSheetAnim, paddingHorizontal: 15, backgroundColor: '#f1f1f1', top: -215 }}>
                {formLoading == true ? (
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                            <View>
                                ...
                                <Text style={{ color: '#747373ff', fontSize: 12, marginTop: -10 }}>{timeWithRoute}</Text>
                            </View>
                        </View>
                    </View>
                )}
