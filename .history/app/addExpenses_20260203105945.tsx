                                                ...
                                                <TouchableOpacity disabled={e.image_uri != null} onPress={() => handleOnCapture(e.id)} style={{ borderColor: '#b3b3b3', borderWidth: 1, borderRadius: 5, height: 90, justifyContent: 'center', position: 'relative' }}>
                                                    {e.image_uri == null ? (
                                                        ...
                                                        <>
                                                            ...
                                                            <View style={{ position: 'absolute', alignSelf: 'center', backgroundColor: '#2e2e2e48', height: '100%', width: '100%', alignItems: 'center', padding: 10 }}>
                                                                <TouchableOpacity style={{ flexDirection: 'row', gap: 3, alignItems: 'center', borderColor: '#fff', borderWidth: 1, padding: 5, alignSelf: 'flex-end' }}>
