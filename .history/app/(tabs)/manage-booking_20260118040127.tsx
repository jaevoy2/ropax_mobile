...
export default function ManageBooking() {
    ...
    const PassengerItem = React.memo(({ paxDatas }: { paxDatas: PaxBookingProps }) => {
        return (
            <View style={{ height: 90, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, padding: 8, marginBottom: 10 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Text style={{ fontSize: 10 }}>{paxDatas.vessel}</Text>
                    <Text style={{ fontSize: 10 }}>|</Text>
                    <Text style={{ fontSize: 10 }}>{paxDatas.route}</Text>
                    <Text style={{ fontSize: 10 }}>|</Text>
                    <Text style={{ fontSize: 10 }}>{paxDatas.departureTime}</Text>
                </View>
            </View>
        )
    })
        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ paddingTop: 50, height: 150, backgroundColor: '#cf2a3a', paddingHorizontal: 20, gap: 15 }}>
                ...
                <View style={{ position: 'relative', borderColor: '#cfcfcf73', backgroundColor: '#d4abab73', borderWidth: 1, borderRadius: 50, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 10 }}>
                    ...
                    {/* <View style={{ backgroundColor: '#fff', position: 'absolute', height: 50, width: '107%', top: 43, elevation: 8, borderRadius: 3, zIndex: 10 }}>
