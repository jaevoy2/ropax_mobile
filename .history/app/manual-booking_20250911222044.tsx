...
export default function ManualBooking() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative' }}>
            <View style={{ paddingTop: 30, height: 100, backgroundColor: '#cf2a3a', paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', zIndex: 1 }}>
            ...
            <View style={{ padding: 20 }}>
                <View style={{ flexDirection: 'row', gap: 10 }}>
                    ...
                    {loading == true && (
                        <View style={{ height: height, backgroundColor: '#000000ff', position: 'absolute', zIndex: 2, top: 0 }} />
                    )}
                    <Modal visible={loading} transparent animationType="fade" style={{ flex: 1, justifyContent: 'center' }}>
