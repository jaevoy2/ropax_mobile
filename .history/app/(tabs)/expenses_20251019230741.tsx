...
export default function Expenses() {
    ...
    useEffect(() => {
        ...
        const month = today.toLocaleString('en-US', { month: 'long', timeZone: 'Asia/Manila' });
    ...
    const handleOnDateSelect = (selectedMonth: string) => {
                    ...
                    <View style={{ width: '80%', backgroundColor: '#fff', padding: 20, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4 }}>
                        ...
                        <CalendarList
                            ...
                            onMonthChange={(month) => {
                                ...
                                const formattedMonth = `${monthName} ${month.year}`

                            setMonth(formattedMonth);
                            setCalendar(false),
                            handleOnDateSelect(formattedMonth)
                        }}
                        />
            ...
            <View style={{ paddingVertical: 15 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomColor: '#CF2A3A', borderBottomWidth: 1, paddingBottom: 5, paddingHorizontal: 15 }}>
                    <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                        ...
                        <Text style={{ color: '#CF2A3A', fontSize: 13, fontWeight: 'bold' }}>October 19, 2025</Text>
                    </View>
                ...
                <TouchableOpacity style={{ paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#f1f1f1', borderBottomColor: '#FFC1C5', borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View>
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: 10 }}>October 19, 2025</Text>
                    </View>
