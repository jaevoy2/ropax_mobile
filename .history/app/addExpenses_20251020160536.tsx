    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height, }}>
            ...
            <View style={{ padding: 10 }}>
                <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-end', padding: 10, backgroundColor: '#cf2a3a', justifyContent: 'center', marginBottom: 15, borderRadius: 8=5 }}>
