    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <TouchableOpacity onPress={() => [setPassengers(prev => [...prev, { passType_id: passesTypeID, accommodation: passesTypeName, passTypeCode: passesTypeCode }]), passesSheetRef.current?.expand()]} style={{ position: 'absolute', right: 20, top: 50, zIndex: 1 }}>
                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1} bottomInset={1}>
                    {isFormVisible == true && (
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginVertical: 15, paddingHorizontal: 10 }}>
                            <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                                <Text style={{ fontSize: 11 }}>Reference#:</Text>
