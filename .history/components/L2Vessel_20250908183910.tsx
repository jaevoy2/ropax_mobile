...
export default function L2Vessel() {
    return (
        <View style={{ width: 335, height: height + 290, backgroundColor: '#FAFAFA', marginTop: 10, paddingTop: 10, borderRadius: 50 }}>
            ...
            <View style={{ marginTop: 15, flexDirection: 'row', gap: 3, alignItems: 'flex-end' }}>
                <View style={{ width: '25%' }}>
                    <SeatPlan start={1} limit={2} letter='P' />
                    <SeatPlan start={1} limit={22} letter='A' />
                </View>
                <View style={{ width: '50%' }}>
                    <SeatPlan start={3} limit={6} letter='P' />
                    <SeatPlan start={1} limit={40} letter='B' />
                </View>
                <View style={{ width: '25%' }}>
                    <SeatPlan start={7} limit={8} letter='P' />
