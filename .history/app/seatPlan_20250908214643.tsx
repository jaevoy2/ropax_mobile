...
export default function SeatPlan() {
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <TouchableOpacity onPress={() => onFormView()} style={{ position: 'absolute', bottom: 10, backgroundColor: '#cf2a3a', width: '100%', alignSelf: 'center', borderRadius: 30, paddingVertical: 10, zIndex: 5 }}>
