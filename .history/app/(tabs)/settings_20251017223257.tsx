...
export default function GenSettings() {
    ...
    const [selectedStation, setSelectedStation] = useState(user!.stationID);
                            ...
                            <>
                                ...
                                <View style={{ flexDirection: 'column', gap: 8, marginTop: 10 }}>
                                    {stationOptions?.map((option) => (
                                        ...
                                        borderColor: '#cf2a3a', borderRadius: 5, backgroundColor: selectedStation == option.id ? '#cf2a3a' : user?.stationID == option.id ? '#cf2a3a' : 'transparent' }}>
                                            <Text style={{ fontWeight: 'bold', color: selectedStation == option.id ? '#fff' : user?.stationID == option.id ? '#fff' : '#cf2a3a' }}>{option.name}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
