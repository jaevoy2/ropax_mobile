...
export default function ManualBooking() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
                ...
                <View style={{ paddingTop: 30, height: 100, backgroundColor: '#cf2a3a', paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => toggleSheet()}>
                            <Ionicons name="list" size={30} color={'#FFC107'} />
                        </TouchableOpacity>
                    </View>
                </View>
            ...
            <Animated.View style={{ opacity: fadeInAnim, position: 'absolute', zIndex: 3 }}>
                <TouchableOpacity style={{ backgroundColor: '#00000065', width: width + 100, height: height, }} />
            </Animated.View>
            <Animated.View style={{ height, position: 'absolute', bottom: 0, backgroundColor: '#fff', width: width, transform: [{ translateY }], borderTopRightRadius: 20, borderTopLeftRadius: 20, zIndex: 4 }}>
                <View>
                    <Text>lol</Text>
                </View>
            </Animated.View>
