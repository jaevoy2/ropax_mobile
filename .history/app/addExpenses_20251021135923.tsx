        ...
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height, }}>
            ...
            <Modal visible={modal} transparent animationType="fade">
                <View style={{ backgroundColor: '#00000048', flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ height: height / 4, width: width - 40, backgroundColor: '#fff', borderRadius: 10, justifyContent: 'space-between', padding: 15 }}>
                        <Text style={{ fontSize: 16, marginTop: 25 }}>Add Category</Text>
                        ...
                        <View style={{ alignSelf: 'flex-end', flexDirection: 'row', marginTop: 20, gap: 10 }}>
                            ...
                            {saveCategotySpinner ? (
                                ...
                                <TouchableOpacity disabled={saveCategotySpinner}>
                                    <Text style={{ color: '#cf2a3a', fontWeight: 'bold' }}>Save Category</Text>
                                </TouchableOpacity>
                            )}
                        </View>
                    </View>
