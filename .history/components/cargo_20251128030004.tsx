...
export default function CargoComponent() {
    ...
    return (
        <View style={{ height: height }}>
            ...
            <Animated.View style={{ height, position: 'absolute', bottom: 0, backgroundColor: '#fff', width: width, transform: [{ translateY: sheetTranslateY }], borderTopRightRadius: 20, borderTopLeftRadius: 20, zIndex: 5 }}>
