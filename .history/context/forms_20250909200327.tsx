    ...
    return (
        <View>
            ...
            <View style={{ height: '81%', marginTop: 10 }}>
                <ScrollView>
                    {passengers.map((p) => (
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 20 }}>
                            ...
                            <View style={{ flexDirection: 'column', alignItems: 'flex-start', marginTop: 10, gap: 5 }}>
                                ...
                                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5 }}>
                                    {passengerType.map((type) => (
                                        <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'passType', type)} key={type} style={{ borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 18, borderRadius: 5  }}>
                            ...
                            <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                    <TextInput onChangeText={(text) => updatePassenger(p.seatNumber!, 'name', text)} placeholder='Last Name, First Name' style={{ fontSize: 13, height: 15}} />
                                </View>
                            </View>
                                ...
                                <View style={{ width: '56%', }}>
                                    ...
                                    <View style={{ flexDirection:'row', gap: 5 }}>
                                        {passGender.map((gender) => (
                                            <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'gender', gender)} key={gender} style={{ borderColor: '#cf2a3a', borderWidth: 1, width: '50%', borderRadius: 5, justifyContent :'center', paddingVertical: 8 }}>
                            ...
                            <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'hasInfant', !p.hasInfant)} style={{ flexDirection: 'row', alignItems: 'center', marginTop: 15 }}>
                            ...
                            {p.hasInfant == true && (
                                <>
                                    <View style={{ marginTop: 10 }}>
                                        <Text style={{ fontSize: 9, fontWeight: 'bold', color: '#545454' }}>Full Name:</Text>
                                        <View style={{ height: 40, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                            <TextInput onChangeText={(text) => updatePassenger(p.seatNumber!, 'infantName', text)} placeholder='Last Name, First Name' style={{ fontSize: 13 }} />
                                        </View>
                                    </View>
                                    <View style={{ marginTop: 5, flexDirection: 'row', gap: 8, alignItems: 'flex-end' }}>
                                        <View style={{ width: '40%' }}>
                                            <Text style={{ fontSize: 9, fontWeight: 'bold', color: '#545454' }}>Age:</Text>
                                            <View style={{ height: 40, borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                                <TextInput onChangeText={(text) => updatePassenger(p.seatNumber!, 'infantAge', Number(text))} keyboardType='numeric' placeholder='Age' style={{ fontSize: 13 }} />
                                            </View>
                                        </View>
                                        <View style={{ width: '56%', }}>
                                            <Text style={{ fontSize: 9, fontWeight: 'bold', color: '#545454' }}>Gender:</Text>
                                            <View style={{ flexDirection:'row', gap: 5 }}>
                                                {passGender.map((gender) => (
                                                    <TouchableOpacity onPress={() => updatePassenger(p.seatNumber!, 'infantGender', gender)} key={gender} style={{ borderColor: '#cf2a3a', borderWidth: 1, width: '50%', borderRadius: 5, justifyContent :'center', paddingVertical: 8 }}>
                                                        <Text style={{ textAlign: 'center', fontSize: 14, color: '#cf2a3a' }}>{gender}</Text>
                                                    </TouchableOpacity>
                                                ))}
                                            </View>
