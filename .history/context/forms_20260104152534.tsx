                                        ...
                                        <View style={{flexDirection: 'row', justifyContent: 'space-between' }}>
                                            <View style={{ width: '70%' }}>
                                                ...
                                                <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                                    ...
                                                    value={c.cargoTypeID} data={cargoProperties?.data.cargo_types.map((type: any) => ({ label: type.name, value: type.id })) } labelField="label" valueField="value" placeholder="Select Cargo Type" style={{ height: 40, width: '90%', paddingHorizontal: 10 }}
                                                        containerStyle={{
