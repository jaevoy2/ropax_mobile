        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ paddingVertical: 15 }}>
                ...
                <View style={{ height: height - 215 }}>
                    <ScrollView>
                        <TouchableOpacity style={{ paddingHorizontal: 15, paddingVertical: 15, backgroundColor: '#FAFAFA', borderBottomColor: '#FFC1C5', borderBottomWidth: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            <View>
