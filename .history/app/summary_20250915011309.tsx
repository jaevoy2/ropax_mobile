    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ padding: 10 }}>
                ...
                <View style={{ backgroundColor: '#fff', borderColor: '#B3B3B3', marginTop: 20, borderWidth: 1, borderRadius: 10, padding: 10, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'column', gap: 15 }}>
                        ...
                        <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                            ...
                            <View style={{ borderBottomColor: '#FFC107', borderBottomWidth: 1, marginTop: -10 }}>
                                <TextInput keyboardType={'numeric'} placeholder='₱00.00' style={{ fontWeight: 'bold', fontSize: 16, paddingBottom: -10, paddingLeft: -10, width: 150, }} />
                            </View>
                        </View>
                    </View>
