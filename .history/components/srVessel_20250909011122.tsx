...
export default function SRVessel({ onSeatSelect }: SRVesselProps) {
    ...
    return (
        <View style={{ width: width - 20, height: height + 290, backgroundColor: '#FAFAFA', marginTop: 20, paddingTop: 10, borderRadius: 50,  }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, width: '80%', alignSelf: 'center', }}>
            ...
            <View style={{ marginTop: 25, paddingHorizontal: 4, width: '100%', gap: 5 }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', width: '100%' }}>
                    <View style={{ width: '46%', alignItems: 'center', backgroundColor: '#000' }}>
                        <Text style={{ fontWeight: 'bold', textAlign: 'center', fontSize: 12, marginBottom: 4 }}>Senior/PWD</Text>
