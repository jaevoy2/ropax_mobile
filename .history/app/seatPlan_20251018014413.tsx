        ...
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#f8f8f8ff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 10, transform: [{ translateY: passessFormAnim }], zIndex: 5 }}>
                ...
                {isPassFormVisible == true && (
                    <View style={{ paddingVertical: 10, position: 'relative', backgroundColor: '#000' }}>
                        {formLoading == true ? (
                            <View style={{ height: '80%', justifyContent: 'center', alignItems: 'center',  }}>
                                <ActivityIndicator size={'large'} color={'#cf2a3a'} />
                            </View>
                        ...
                        <TouchableOpacity onPress={() => handleSave()} style={{ position: 'absolute', bottom: 20, backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15, zIndex: 5 }}>
                            {saveloading == true ? (
