...
export default function PaymentSummary() {
    ...
    const { id, totalFare, fareChange, webCode, mobileCode, destination, origin, setRefNumber, setFareChange, setCashTendered } = useTrip();
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            ...
            <View style={{ padding: 10 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10, paddingBottom: 10, borderBottomColor: '#cf2a3a', borderBottomWidth: 1 }}>
                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 20, paddingVertical: -2, paddingHorizontal: 10, textAlign: 'right', borderColor: '#353535ff', borderWidth: 1 }} />
                        </View>
                    </View>
                </View>
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                            ...
                            <Text style={{ fontSize: 20, fontWeight: '900' }}>{cashTendered != 0 ? fareChange : '00.00'}</Text>
                        </View>
                    </View>
                </View>
            </View>
