...
export default function TicketGenerator() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', height: height }}>
            <TouchableOpacity style={{ position: 'absolute', top: 45, left: 10, zIndex: 3 }}>
                    ...
                    <View style={{ flexDirection: 'column', gap: 15 }}>
                        ...
                        <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                            ...
                            <View style={{ borderBottomColor: '#FFC107', borderBottomWidth: 1, marginTop: -10 }}>
                                <TextInput keyboardType={'numeric'} placeholder='₱00.00' style={{ fontWeight: 'bold', fontSize: 16, paddingBottom: -6, paddingLeft: -10, width: 150, }} />
                            </View>
                        </View>
                    </View>
