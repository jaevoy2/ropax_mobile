                ...
                {formLoading == true ? (
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <TouchableOpacity onPress={() => closeFormSheet()} style={{ flexDirection: 'row', alignItems: 'center', gap: 5, paddingVertical: 10, paddingHorizontal: 15, backgroundColor: '#cf2a3a', borderRadius: 5 }}>
                                <Ionicons name={'swap-horizontal'} color={'#fff'} size={18} />
