...
export default function AddExpenses() {
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', position: 'relative', flex: 1, }}>
            {/* add category modal */}
            ...
            <View style={{ padding: 10, marginTop: 20 }}>
                ...
                <View style={{ minHeight: height - 350, marginTop: 10, maxHeight: height - 300 }}>
                    <ScrollView>
                        {expenses.map((e, index) => (
                            <View key={index} style={{ padding: 10, marginTop: 15, borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 8 }}>
                                {index !== 0 && (
                                    <Ionicons name={'close'} size={25} color={'#cf2a3a'} style={{ alignSelf: 'flex-end' }} />
                                )}
                                <View>
