    ...
    return (
        <View style={{ height: height }}>
            <ScrollView style={{ height: '100%', backgroundColor: '#000' }}>
                ...
                <Animated.View style={{ paddingHorizontal: 15, paddingTop: 10, backgroundColor: '#f1f1f1', transform: [{ translateX: tripsAnimation }], bottom: '105%', minHeight: '100%', top: 0, left: 0, right: 0 }}>
                    {formLoading == true ? (
