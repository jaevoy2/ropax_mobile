            ...
            <View style={{ padding: 10, marginTop: 20 }}>
                ...
                <View style={{ padding: 10, borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 8 }}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 15, marginBottom: 5 }}>
                        {trips?.map((t) => (
                            <>
                                <TouchableOpacity onPress={() => setSelectedTrip(t.trip_id)} key={t.trip_id} style={{ backgroundColor: selectedTrip == t.trip_id ? '#cf2a3a' : 'transparent', borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 5, paddingHorizontal: 5, borderRadius: 5  }}>
                                    <View>
