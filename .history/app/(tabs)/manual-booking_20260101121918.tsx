    ...
    return (
        <GestureHandlerRootView style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <View>
                ...
                <ScrollView refreshControl={ bookingType == 'Cargo' && cargoOnlyProperty.length > 0 ? undefined : <RefreshControl refreshing={refresh} onRefresh={handleRefresh} colors={['#cf2a3a']} progressViewOffset={120} />} nestedScrollEnabled={true} >
                    {bookingType == 'Walk-In' ? (
