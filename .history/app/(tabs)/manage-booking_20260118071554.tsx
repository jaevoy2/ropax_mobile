            ...
            <TouchableOpacity style={{ height: 90, borderColor: '#B3B3B3', borderWidth: 1, backgroundColor: '#fff', borderRadius: 8, padding: 8, marginBottom: 10 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3 }}>
                        ...
                        <MaterialCommunityIcons name={paxDatas.bookingStatus == null ? 'check-decagram' : 'clock-time-eight'} size={16} color={paxDatas.bookingStatus == null ? '#FCCA03' : '#19B87E'} />
                    </View>
                </View>
            </TouchableOpacity>
        )
