            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#f8f8f8ff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 10, transform: [{ translateY }], zIndex: 5 }}>
                ...
                {isFormVisible == true && (
                    <View style={{ paddingVertical: 10, position: 'relative' }}>
                        ...
                        {/* buttons */}
                        {isExpanded == true && isPassFormVisible != true  && (
                            <TouchableOpacity onPress={() => onFormView()} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15, zIndex: 5 }}>
                                <Text style={{ fontSize: 16, fontWeight: 'bold', textAlign: 'center', color: '#fff' }}>Continue</Text>
                            </TouchableOpacity>
                        )}
                        {isFormVisible == true && (
                            <TouchableOpacity onPress={() => handleSave()} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15, zIndex: 5 }}>
                                {saveloading == true ? (
