            ...
            <View style={{ padding: 10 }}>
                <View style={{ paddingHorizontal: 15, paddingVertical: 20, backgroundColor: '#fff', borderRadius: 10, marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                        <Image source={defaultImg} style={{ borderRadius: 60, height: 30, width: 30 }} />
                        <View>
                            <Text style={{ fontWeight: 'bold', fontSize: 16, color: '#cf2a3a' }}>Dedal Boyet</Text>
                            <Text style={{ fontSize: 12, color: '#D9DCE2' }}>Ticketing Staff</Text>
                        </View>
                    </View>
                    <View style={{ flexDirection: 'column', alignItems: 'flex-end' }}>
                        <Text style={{ fontSize: 13, color: '#D9DCE2' }}>Station</Text>
