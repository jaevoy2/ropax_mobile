                ...
                <View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, borderBottomColor: '#c9c9c9ff', borderBottomWidth: 1, }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'flex-start' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 16, textAlign: 'right', borderColor: '#c9c9c9ff', borderWidth: 1, borderRadius: 5 }} />
                        </View>
                    </View>
                </View>
