...
export default function TicketGenerator() {
    const { mobileCode, origin, destination, cashTendered, fareChange, totalFare, departure_time, refNumber, clearTrip } = useTrip();
            ...
            <View style={{ position: 'relative', height: '80%', top: -70 }}>
                <ScrollView>
                    <View ref={viewRef} style={{ backgroundColor: '#fff', left: '50%', transform: [{ translateX: '-50%' }], width: '85%', borderRadius: 10, padding: 10 }}>
                        ...
                        {paxCargoProperty.some((c => c.withPassenger == true)) ? (
                            <>
                            ...
                            <View style={{ borderBottomColor: '#9B9B9B', borderBottomWidth: 1, paddingVertical: 10, marginTop: 10 }}>
