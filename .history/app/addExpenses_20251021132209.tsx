            ...
            <View style={{ padding: 10, marginTop: 20 }}>
                ...
                <View style={{ padding: 10, borderColor: '#cf2a3a', borderWidth: 1, borderRadius: 8 }}>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginVertical: 10 }}>
                        {trips?.map((t) => (
                            <>
                                <TouchableOpacity key={t.trip_id} style={{ backgroundColor: 'transparent', borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 8, borderRadius: 5  }}>
                                    <View>
