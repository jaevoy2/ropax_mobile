...
export const TripProvider = ({ children }: TripProviderProps) => {
    ...
    return (
        <TripContext.Provider value={{ id, vessel, routeID, origin, destination, vessel_id, totalFare, note, departure_time, fareChange, code, webCode, mobileCode, cashTendered, refNumber,
                                    setVessel, setID, setRouteID, setOrigin, setDestination, setVesselID, setTotalFare, setNote, setDepartureTime, setFareChange, setCode, setWebCode, setMobileCode, setCashTendered, setRefNumber, clearTrip }}>
            {children}
