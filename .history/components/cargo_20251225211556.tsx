...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    useEffect(() => {
        ...
        console.log(cargoProperties.data.cargos.find((cargo: any) => cargo.cargo_type_id == paxCargoProps.cargoTypeID && cargo.cargo_brand_id == paxCargoProps.brandID && cargo.cargo_specification_id == paxCargoProps.specificationID))
