...
import { ActivityIndicator, Alert, Animated, Dimensions, Modal, RefreshControl, ScrollView, Text, TextInput, TouchableOpacity, View } from "react-native";
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <ScrollView refreshControl={ <RefreshControl refreshing={refresh} onRefresh={handleRefresh} colors={['#cf2a3a']} /> } >
                <View style={{ paddingTop: 50, height: 170, backgroundColor: '#cf2a3a', paddingHorizontal: 20, gap: 10 }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3, backgroundColor: '#ffff', paddingVertical: 3, paddingHorizontal: 10, borderRadius: 60 }}>
                        <Ionicons name={'search'} size={20} />
                        <TextInput placeholder="Search Passenger"/>
                    </View>
                </View>
            ...
            <Animated.View style={{ height, position: 'absolute', bottom: 0, backgroundColor: '#fff', width: width, transform: [{ translateY }], borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                <View style={{ padding: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 15, color: '#cf2a3a' }}>0 TOTAL PAYING PASSENGERS</Text>
