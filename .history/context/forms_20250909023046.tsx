                        ...
                        <View key={p.seatNumber} style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                                    ...
                                    <Text style={{ textAlign: 'center', fontWeight: 'bold', fontSize: 15, color: '#cf2a3a', borderColor: '#cf2a3a', backgroundColor: '#cf2a3b1a', borderWidth: 1, paddingVertical: 5, paddingHorizontal: 25, borderRadius: 5 }}>
                                        {p.seatNumber}
                                    </Text>
                                </View>
                            ...
                            <View style={{ flexDirection: 'column', alignItems: 'flex-start' }}>
                                <Text style={{ fontSize: 9, fontWeight: 'bold', color: '#545454' }}>Passenger Type:</Text>
                                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5 }}>
                                    {passengerType.map((type) => (
                                        <TouchableOpacity key={type} style={{ borderColor: '#cf2a3a', borderWidth: 1, paddingVertical: 4, paddingHorizontal: 18, borderRadius: 5  }}>
                                            <Text style={{ textAlign: 'center', fontSize: 13, color: '#cf2a3a' }}>{type}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
                            </View>
