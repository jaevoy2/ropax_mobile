...
export const CargoProvider = ({ children }: {children: ReactNode}) => {
    ...
    const totalAmount = React.useMemo<CargoTotalAmount>(() => {
    ...
    return (
        <CargoContext.Provider value={{ totalAmount, cargoProperties, cargoOnlyProperty, setCargoProperties, setCargoOnlyProperty, updateCargoOnlyProperty }}>
            {children}
