                    ...
                    <View>
                        ...
                        <View style={{ borderColor: '#B3B3B3', padding: 10, borderRadius: 8, borderWidth: 1, marginTop: 10 }}>
                            ...
                            <View style={{ marginTop: 10 }}>
                                ...
                                <View style={{ borderColor: '#B3B3B3', borderWidth: 1, borderRadius: 5 }}>
                                    <Dropdown onChange={(item) => {updateCargo(0, 'brand', item.value), setSelectdBrand(brands.map(b => b.name))}} value={selectedBrand} data={brands.map((b: any) => ({ label: b.name })) } labelField="label" valueField="value" placeholder="Select Brand" style={{ height: 40, width: '100%', paddingHorizontal: 10 }}
                                        containerStyle={{
