...
export default function SeatPlan() {
    ...
    const seatSnapPoints = useMemo(() => ["26%", "85%"], []);
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <View style={{ height: '100%' }}>
                ...
                <TouchableOpacity onPress={() => passesSheetRef.current?.expand()} style={{ position: 'absolute', right: 20, top: 50, zIndex: 5 }}>
                ...
                <View style={{ position: 'absolute', paddingTop: 50, width: width, flex: 1 }}>
                    ...
                    <View style={{ paddingTop: 10, height: height - 60 }}>
                        <ScrollView style={{ height: '100%' }} contentContainerStyle={{ paddingBottom: 200 }}>
                ...
                <BottomSheet ref={seatSheetRef} snapPoints={seatSnapPoints} index={-1} enablePanDownToClose={true}>
                    <BottomSheetScrollView contentContainerStyle={{ padding: 10 }}>
                        ...
                        {isFormVisible == false ? (
                            <TouchableOpacity onPress={() => {setIsFormVisible(true), seatSheetRef.current?.snapToIndex(1)}} style={{ backgroundColor: '#cf2a3a', width: '95%', alignSelf: 'center', borderRadius: 30, paddingVertical: 15 }}>
