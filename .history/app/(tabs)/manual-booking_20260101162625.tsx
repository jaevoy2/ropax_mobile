...
export default function ManualBooking() {
    ...
    return (
        <GestureHandlerRootView style={{ backgroundColor: '#f1f1f1', height: height, position: 'relative' }}>
            ...
            <View>
                <View style={{ flexDirection: 'row', gap: 10, paddingHorizontal: 15, paddingTop: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{bookingType != 'Cargo' ? 'Select Trip' : 'Selected Trip'}</Text>
                ...
                <ScrollView refreshControl={ bookingType == 'Cargo' ? undefined : (<RefreshControl refreshing={refresh} onRefresh={handleRefresh} colors={['#cf2a3a']} progressViewOffset={60} />)} nestedScrollEnabled={true} >
                    {bookingType == 'Walk-In' ? (
