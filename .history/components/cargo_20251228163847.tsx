...
export default function CargoComponent({ dateChange }: {dateChange: string} ) {
    ...
    const handleCargoAmount = (cargo: any, cargoId: number ) => {
        const getAmount = ComputedCargoAmount(cargo);

        updateCargoOnlyProperty(cargoId, 'cargoAmount', getAmount);
        // return getAmount;
    }
