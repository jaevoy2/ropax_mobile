            ...
            <View style={{ height: '100%', overflow: 'hidden' }}>
                ...
                <BottomSheet ref={passesSheetRef} snapPoints={seatSnapPoints} index={-1}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10 }}>
                        ...
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', borderColor: '#cf2a3a', borderWidth: 1, paddingHorizontal: 8, paddingVertical: 5 }} onPress={() => [setPassengers([]), passesSheetRef.current?.close()]}>
