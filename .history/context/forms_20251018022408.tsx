            ...
            <View style={{ height: '82%', marginTop: 10 }}>
                <ScrollView>
                    {passengers.map((p, index) => (
                        <View key={p.passType_id! + index} style={{ borderColor: errorForm.includes(p.seatNumber ?? '') ? '#cf2a3a' : '#B3B3B3', borderWidth: 1, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 10, marginBottom: 20, backgroundColor: '#fff' }}>
