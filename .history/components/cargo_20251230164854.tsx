                ...
                {formLoading == true ? (
                    ...
                    <View style={{ paddingTop: 40 }}>
                        ...
                        <View style={{ height: height - 350, marginTop: 10 }}>
                            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, position: 'relative', zIndex: 1000 }}>
                                <ScrollView keyboardShouldPersistTaps="handled" nestedScrollEnabled={true}>
                                    ...
                                    <View style={{ borderColor: '#B3B3B3', backgroundColor: '#fff', padding: 10, borderRadius: 8, borderWidth: 1, height: 90, marginTop: 10 }}>
