...
export default function SeatPlan() {
    ...
    return (
        <View style={{ height: '100%', position: 'relative' }}>
            ...
            <Animated.View style={{ position: 'absolute', bottom: 0, width: width, height, backgroundColor: '#f8f6f6ff', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 10, transform: [{ translateY }], zIndex: 5 }}>
