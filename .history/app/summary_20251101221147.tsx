                ...
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginTop: -10, flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <TextInput onChangeText={(text) => setPassCashTendered(Number(text))} keyboardType={'numeric'} placeholder='00.00' style={{ fontWeight: 'bold', fontSize: 20, paddingBottom: -2, paddingLeft: -10, width: 100, textAlign: 'right', borderColor: '#FFC107', borderBottomWidth: 1 }} />
                        </View>
                    </View>
                </View>
                <View style={{ paddingVertical: 10 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                            ...
                            <Text style={{ fontSize: 20, fontWeight: '900', color: '#000' }}>{cashTendered != 0 ? fareChange : '00.00'}</Text>
                        </View>
                    </View>
                </View>
            </View>
