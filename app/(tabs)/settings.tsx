...
export default function GenSettings() {
    ...
    const handleSaveStation = async () => {
        setSaveSpinner(true);
        console.log(user!.id, selectedStation);
    ...
    return (
        <View>
            ...
            <View style={{ padding: 10 }}>
                <View style={{ paddingHorizontal: 15, paddingVertical: 20, backgroundColor: '#fff', borderRadius: 10, borderColor: '#cf2a3a', borderWidth: 1, marginTop: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <TouchableOpacity onPress={() => router.push('/expenses')} style={{ paddingHorizontal: 15, paddingVertical: 20, backgroundColor: '#fff', borderRadius: 10, marginTop: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', gap: 15, alignItems: 'center' }}>
                        <MaterialCommunityIcons name="currency-php" size={30} color={'#cf2a3a'} />
                        <View>
                            <Text style={{ fontWeight: 'bold', fontSize: 16, color: '#cf2a3a' }}>Expenses</Text>
                            <Text style={{ fontSize: 12, color: '#666' }}>Set daily operating expenses</Text>
                        </View>
                    </View>
                    <Ionicons name="chevron-forward" size={18} />
                </TouchableOpacity>
                <TouchableOpacity onPress={fetchStations} style={{ paddingHorizontal: 15, paddingVertical: 20, backgroundColor: '#fff', borderRadius: 10, marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
