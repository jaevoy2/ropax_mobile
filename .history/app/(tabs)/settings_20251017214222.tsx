                            ...
                            <>
                                ...
                                <View style={{ flexDirection: 'column', gap: 8, marginTop: 10 }}>
                                    {stationOptions?.map((option) => (
                                        <TouchableOpacity onPress={() => setSelectedStation(option.id)} key={option.id} style={{ paddingHorizontal: 8, paddingVertical: 10, borderWidth: 1, borderColor: '#cf2a3a', borderRadius: 5, backgroundColor: selectedStation == option.id ? '#cf2a3a' : '#cf2a3b2d' }}>
                                            <Text style={{ fontWeight: 'bold', color: selectedStation == option.id ? '#fff' : '' }}>{option.name}</Text>
                                        </TouchableOpacity>
                                    ))}
                                </View>
