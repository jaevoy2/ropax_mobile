    ...
    return (
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
            {items.map((seat) => (
                ...
                borderRadius: 3, backgroundColor: touristSeat.includes(seat) ? '#E6E2C6' : passengers.some((p) => p.seatNumber == Number(seat)) && !touristSeat.includes(seat) ? '#BA68C8' : 'transparent', alignItems: 'center', justifyContent: 'center', margin: 2 }}>
