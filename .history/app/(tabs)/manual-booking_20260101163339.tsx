            ...
            <View>
                <View style={{ flexDirection: 'row', gap: 10, paddingHorizontal: 15, paddingTop: 20 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{bookingType != 'Cargo' ? 'Select Trip' : ''}</Text>
                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>{bookingType != 'Cargo' ? formattedDate.split('(')[0] : ''}</Text>
                    </View>
